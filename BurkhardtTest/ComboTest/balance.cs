...
namespace ComboTest
{
    ...
    {
        static void bal_seq_check_test()
            ...
            //
        {
            ...
            for (test = 1; test <= 3; test++)
            {
                ...
                if (test == 1)
                {
                    t = typeMethods.i4vec_copy_new(2 * n, t1);
                }
                else if (test == 2)
                {
                    t = typeMethods.i4vec_copy_new(2 * n, t2);
                }
                else if (test == 3)
                {
                    t = typeMethods.i4vec_copy_new(2 * n, t3);
                }
        ...
        static void bal_seq_successor_test()
        ...
        static void bal_seq_to_tableau_test()
        ...
        static void bal_seq_unrank_test()
