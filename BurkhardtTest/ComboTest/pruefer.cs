...
namespace ComboTest
{
    ...
    {
        static void pruefer_check_test()
        ...
        static void pruefer_successor_test()
        ...
        static void pruefer_to_tree_test()
        ...
        static void pruefer_unrank_test()
