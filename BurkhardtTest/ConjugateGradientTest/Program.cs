...
namespace ConjugateGradientTest
{
    class Program
    {
            ...
            //
        {
            ...
            //
            b = typeMethods.r8ge_mv(n, n, a, x1);
            //
            //  Call the CG routine.
            //
            x2 = new double[n];
            ...
            //
            r = typeMethods.r8ge_res(n, n, a, x2, b);
            r_norm = typeMethods.r8vec_norm(n, r);
            //
            //  Compute the error.
            //
            e_norm = typeMethods.r8vec_norm_affine(n, x1, x2);
            //
            //  Report.
            //
            Console.WriteLine("");
            ...
            //
        {
            ...
            //  Compute the residual.
            //
            r = typeMethods.r83_res(n, n, a, x2, b);
            r_norm = typeMethods.r8vec_norm(n, r);
            //
            //  Compute the error.
            //
            ...
            //
        {
            ...
            //  Compute the corresponding right hand side.
            //
            b = typeMethods.r83s_mv(n, n, a, x1);
            //
            //  Call the CG routine.
            //
            x2 = new double[n];
            ...
            //  Compute the residual.
            //
            r = typeMethods.r83s_res(n, n, a, x2, b);
            r_norm = typeMethods.r8vec_norm(n, r);
            //
            //  Compute the error.
            //
            ...
            //
        {
            ...
            //  Compute the corresponding right hand side.
            //
            b = typeMethods.r83t_mv(n, n, a, x1);
            //
            //  Call the CG routine.
            //
            x2 = new double[n];
            ...
            //  Compute the residual.
            //
            r = typeMethods.r83t_res(n, n, a, x2, b);
            r_norm = typeMethods.r8vec_norm(n, r);
            //
            //  Compute the error.
            //
            ...
            //
        {
            ...
            //  Let A be the -1 2 -1 matrix.
            //
            a = typeMethods.r8pbu_dif2(n, n, mu);
            //
            //  Choose a random solution.
            //
            seed = 123456789;
            ...
            //  Compute the corresponding right hand side.
            //
            b = typeMethods.r8pbu_mv(n, n, mu, a, x1);
            //
            //  Call the CG routine.
            //
            x2 = new double[n];
            ...
            //  Compute the residual.
            //
            r = typeMethods.r8pbu_res(n, n, mu, a, x2, b);
            r_norm = typeMethods.r8vec_norm(n, r);
            //
            //  Compute the error.
            //
            ...
            //
        {
            ...
            //  Let A be the -1 2 -1 matrix.
            //
            a = typeMethods.r8sd_dif2(n, n, ndiag, offset);
            //
            //  Choose a random solution.
            //
            seed = 123456789;
            ...
            //  Compute the corresponding right hand side.
            //
            b = typeMethods.r8sd_mv(n, n, ndiag, offset, a, x1);
            //
            //  Call the CG routine.
            //
            x2 = new double[n];
            ...
            //  Compute the residual.
            //
            r = typeMethods.r8sd_res(n, n, ndiag, offset, a, x2, b);
            r_norm = typeMethods.r8vec_norm(n, r);
            //
            //  Compute the error.
            //
            ...
            //
        {
            ...
            //  Let A be the -1 2 -1 matrix.
            //
            a = typeMethods.r8sp_dif2(n, n, nz_num, row, col);
            //
            //  Choose a random solution.
            //
            seed = 123456789;
            ...
            //  Compute the corresponding right hand side.
            //
            b = typeMethods.r8sp_mv(n, n, nz_num, row, col, a, x1);
            //
            //  Call the CG routine.
            //
            x2 = new double[n];
            ...
            //  Compute the residual.
            //
            r = typeMethods.r8sp_res(n, n, nz_num, row, col, a, x2, b);
            r_norm = typeMethods.r8vec_norm(n, r);
            //
            //  Compute the error.
            //
