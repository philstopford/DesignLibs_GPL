...
namespace DREAMTest
{
    class Program
    {
        ...
        static void test01()
        {
            ...
            Dream.dream(ref ps, ref pv, t00_prior_sample, t00_prior_density, t00_sample_likelihood );

        }
        
        static double t00_prior_density(int par_num, double[] zp, int zpIndex = 0)
        ...
        static double[] t00_prior_sample(int par_num)
        ...
        static double t00_sample_likelihood(int par_num, double[] zp)
