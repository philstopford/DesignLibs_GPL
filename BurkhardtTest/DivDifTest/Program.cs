...
namespace DivDifTest
{
    class Program
    {
        ...
        static void roots_to_r8poly_test()
        ...
        static void dif_derivk_table_test()
        ...
        static void dif_basis_deriv_test()
        ...
        static void dif_basis_derivk_test()
