...
namespace FD1DHeatExplicitTest
{
    class Program
    {
        ...
        static void fd1d_heat_explicit_test01()
        ...
        static double[] bc_test01(int x_num, double[] x, double t, double[] h )
        ...
        static double[] ic_test01(int x_num, double[] x, double t )
        ...
        static double[] rhs_test01(int x_num, double[] x, double t )
