...
namespace FD1DHeatImplicitTest
{
    class Program
    {
        ...
        static void f(double a, double b, double t0, double t, int n, double[] x,
                ref double[] value)
        ...
        static void u0(double a, double b, double t0, int n, double[] x, ref double[] value )
        ...
        static double ua(double a, double b, double t0, double t)
        ...
        static double ub(double a, double b, double t0, double t)
