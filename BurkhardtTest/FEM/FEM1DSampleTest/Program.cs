...
internal static class Program
{
        ...
        //
    {
        ...
        double[] sample_value = FEM_1D_Sample.fem1d_evaluate(fem_node_num, fem_node_x, fem_element_order,
            fem_element_num, fem_value_dim, fem_value, sample_node_num, sample_node_x);
        //
        //  Write the sample values.
        //
        typeMethods.r8mat_write(sample_value_filename, fem_value_dim, sample_node_num,
            sample_value);
