...
namespace Burkardt.FEM2DBVPQuadraticTest
{
    class Program
    {
            ...
            //
        {
            ...
            u = FEM_2D_BVP_Quadratic.fem2d_bvp_quadratic(nx, ny, a1, c1, f1, x, y);
            ...
            e1 = FEM_2D_BVP_Quadratic.fem2d_l1_error(nx, ny, x, y, u, exact1);
            e2 = FEM_2D_BVP_Quadratic.fem2d_l2_error_quadratic(nx, ny, x, y, u, exact1);
            h1s = FEM_2D_BVP_Quadratic.fem2d_h1s_error_quadratic(nx, ny, x, y, u, exact_ux1, exact_uy1);
            Console.WriteLine("");
        ...
        static double a1(double x, double y)
        ...
        static double c1(double x, double y)
        ...
        static double exact1(double x, double y)
        ...
        static double exact_ux1(double x, double y)
        ...
        static double exact_uy1(double x, double y)
