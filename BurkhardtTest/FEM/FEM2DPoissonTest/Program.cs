...
internal class Program
{
        ...
        //
    {
        ...
        node_r = prefix switch
        {
            "ell" => Matrix.residual_poisson(node_num, node_xy, node_condition, element_num, element_node, quad_num, ib,
                a, f, node_u, ell.rhs, ell.h_coef, ell.k_coef, ell.dirichlet_condition),
            "lake" => Matrix.residual_poisson(node_num, node_xy, node_condition, element_num, element_node, quad_num,
                ib, a, f, node_u, lake.rhs, lake.h_coef, lake.k_coef, lake.dirichlet_condition),
            _ => node_r
        };
