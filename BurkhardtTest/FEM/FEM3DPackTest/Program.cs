...
internal static class Program
{
        ...
        //
    {
        ...
        double[] ref_ = Reference.reference_tet4_uniform(n, ref seed);

        double[] phy = Reference.reference_to_physical_tet4(t, n, ref ref_);
        double[] ref2 = PhysicalToRef.physical_to_reference_tet4(t, n, phy);
