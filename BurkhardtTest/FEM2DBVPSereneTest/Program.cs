...
namespace Burkadt.FEM2DBVPSereneTest
{
    class Program
    {
        ...
        static double a3(double x, double y)
        ...
        static double c3(double x, double y)
        ...
        static double exact3(double x, double y)
        ...
        static double exact_ux3(double x, double y)
        ...
        static double exact_uy3(double x, double y)
