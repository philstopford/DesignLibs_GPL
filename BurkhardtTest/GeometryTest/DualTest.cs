...
public static class DualTest
{
        ...
        //
    {
        ...
        int[] face_order1 = new int[face_num1];
        int[] face_point1 = new int[face_order_max1 * face_num1];
        double[] point_coord1 = new double[DIM_NUM * point_num1];
        ...
        int[] edge_point1 = new int[2 * edge_num1];
        face_order1 = new int[face_num1];
        face_point1 = new int[face_order_max1 * face_num1];
        point_coord1 = new double[DIM_NUM * point_num1];
        ...
        //
    {
        ...
        int[] face_point2 = new int[face_order_max2 * face_num2];
        double[] point_coord2 = new double[DIM_NUM * point_num2];
