...
namespace BarycentricInterp1DTest
{
    class Program
    {
        ...
        static void lagcheby1_interp_1d_test(int prob, int nd)
        ...
        static void lagcheby2_interp_1d_test(int prob, int nd)
        ...
        static void lageven_interp_1d_test(int prob, int nd)
