...
public static class Data_2D
{
        ...
        //
    {
        switch (fi)
        {
            ...
            default:
                Console.WriteLine("");
                Console.WriteLine("F00_F0 - Fatal error!");
                Console.WriteLine("  Illegal function index FI = " + fi + "");
                break;
        }
    }

    public static void f00_f1(int fi, int n, double[] x, double[] y, double[] fx, ref double[] fy)
        //****************************************************************************80
        //
        //  Purpose:
        //
        ...
        //
    {
        ...
        {
            case 1:
                f01_f1(n, x, y, ref fx, ref fy);
                break;
            case 2:
                f02_f1(n, x, y, ref fx, ref fy);
                break;
            case 3:
                f03_f1(n, x, y, ref fx, ref fy);
                break;
            case 4:
                f04_f1(n, x, y, ref fx, ref fy);
                break;
            case 5:
                f05_f1(n, x, y, ref fx, ref fy);
                break;
            case 6:
                f06_f1(n, x, y, ref fx, ref fy);
                break;
            case 7:
                f07_f1(n, x, y, ref fx, ref fy);
                break;
            case 8:
                f08_f1(n, x, y, ref fx, ref fy);
                break;
            case 9:
                f09_f1(n, x, y, ref fx, ref fy);
                break;
            case 10:
                f10_f1(n, x, y, ref fx, ref fy);
                break;
            case 11:
                f11_f1(n, x, y, ref fx, ref fy);
                break;
            case 12:
                f12_f1(n, x, y, ref fx, ref fy);
                break;
            case 13:
                f13_f1(n, x, y, ref fx, ref fy);
                break;
            default:
                Console.WriteLine("");
                Console.WriteLine("F00_F1 - Fatal error!");
                Console.WriteLine("  Illegal function index FI = " + fi + "");
                break;
        }
    }

    public static void f00_f2(int fi, int n, double[] x, double[] y, ref double[] fxx, ref double[] fxy,
            ref double[] fyy)
        //****************************************************************************80
        //
        //  Purpose:
        ...
        //
    {
        ...
        {
            case 1:
                f01_f2(n, x, y, ref fxx, ref fxy, ref fyy);
                break;
            case 2:
                f02_f2(n, x, y, ref fxx, ref fxy, ref fyy);
                break;
            case 3:
                f03_f2(n, x, y, ref fxx, ref fxy, ref fyy);
                break;
            case 4:
                f04_f2(n, x, y, ref fxx, ref fxy, ref fyy);
                break;
            case 5:
                f05_f2(n, x, y, ref fxx, ref fxy, ref fyy);
                break;
            case 6:
                f06_f2(n, x, y, ref fxx, ref fxy, ref fyy);
                break;
            case 7:
                f07_f2(n, x, y, ref fxx, ref fxy, ref fyy);
                break;
            case 8:
                f08_f2(n, x, y, ref fxx, ref fxy, ref fyy);
                break;
            case 9:
                f09_f2(n, x, y, ref fxx, ref fxy, ref fyy);
                break;
            case 10:
                f10_f2(n, x, y, ref fxx, ref fxy, ref fyy);
                break;
            case 11:
                f11_f2(n, x, y, ref fxx, ref fxy, ref fyy);
                break;
            case 12:
                f12_f2(n, x, y, ref fxx, ref fxy, ref fyy);
                break;
            case 13:
                f13_f2(n, x, y, ref fxx, ref fxy, ref fyy);
                break;
            default:
                Console.WriteLine("");
                Console.WriteLine("F00_F2 - Fatal error!");
                Console.WriteLine("  Illegal function index FI = " + fi + "");
                break;
        }
    }

    public static int f00_num()
        //****************************************************************************80
        //
        //  Purpose:
        //
    ...
    public static string f00_title(int fi)
        ...
        //
    {
        ...
        switch (fi)
        {
            ...
            default:
                Console.WriteLine("");
                Console.WriteLine("F00_TITLE - Fatal error!");
                Console.WriteLine("  Illegal function index FI = " + fi + "");
                break;
        }
    ...
    public static void f01_f0(int n, double[] x, double[] y, ref double[] f)
        //****************************************************************************80
        //
        //  Purpose:
        //
        ...
        //
    {
        ...
        {
            f[i] =
                0.75 * Math.Exp(-(Math.Pow(9.0 * x[i] - 2.0, 2)
                                  + Math.Pow(9.0 * y[i] - 2.0, 2)) / 4.0)
                + 0.75 * Math.Exp(-Math.Pow(9.0 * x[i] + 1.0, 2) / 49.0
                                  - (9.0 * y[i] + 1.0) / 10.0)
                + 0.5 * Math.Exp(-(Math.Pow(9.0 * x[i] - 7.0, 2)
                                   + Math.Pow(9.0 * y[i] - 3.0, 2)) / 4.0)
                - 0.2 * Math.Exp(-Math.Pow(9.0 * x[i] - 4.0, 2)
                                 - Math.Pow(9.0 * y[i] - 7.0, 2));
        }

    }

    public static void f01_f1(int n, double[] x, double[] y, ref double[] fx, ref double[] fy)
        //****************************************************************************80
        //
        //  Purpose:
        //
        ...
        //
    {
        for (int i = 0; i < n; i++)
        {
            double t1 = Math.Exp(-(Math.Pow(9.0 * x[i] - 2.0, 2)
                                   + Math.Pow(9.0 * y[i] - 2.0, 2)) / 4.0);
            double t2 = Math.Exp(-Math.Pow(9.0 * x[i] + 1.0, 2) / 49.0
                                 - (9.0 * y[i] + 1.0) / 10.0);
            double t3 = Math.Exp(-(Math.Pow(9.0 * x[i] - 7.0, 2)
                                   + Math.Pow(9.0 * y[i] - 3.0, 2)) / 4.0);
            double t4 = Math.Exp(-Math.Pow(9.0 * x[i] - 4.0, 2)
                                 - Math.Pow(9.0 * y[i] - 7.0, 2));
    ...
    public static void f01_f2(int n, double[] x, double[] y, ref double[] fxx, ref double[] fxy,
            ref double[] fyy)
        //****************************************************************************80
        //
        //  Purpose:
        ...
        //
    {
        for (int i = 0; i < n; i++)
        {
            ...
            fxx[i] =
                15.1875 * (Math.Pow(9.0 * x[i] - 2.0, 2) - 2.0) * t1
                + 60.75 * (Math.Pow(9.0 * x[i] + 1.0, 2) - 24.5) * t2
                + 10.125 * (Math.Pow(9.0 * x[i] - 7.0, 2) - 2.0) * t3
                - 64.8 * (Math.Pow(9.0 * x[i] - 4.0, 2) - 0.5) * t4;
            ...
            fyy[i] =
                15.1875 * (Math.Pow(9.0 * y[i] - 2.0, 2) - 2.0) * t1
                + 0.6075 * t2
                + 10.125 * (Math.Pow(9.0 * y[i] - 3.0, 2) - 2.0) * t3
                - 64.8 * (Math.Pow(9.0 * y[i] - 7.0, 2) - 0.5) * t4;

        }
    }

    public static string f01_title()
        //****************************************************************************80
        //
        //  Purpose:
        //
        ...
        //
    {
        string ft = "Exponential";

        return ft;
    }

    public static void f02_f0(int n, double[] x, double[] y, ref double[] f)
        //****************************************************************************80
        //
        //  Purpose:
        //
        ...
        //
    {
        for (int i = 0; i < n; i++)
        {
            f[i] = (Math.Tanh(9.0 * (y[i] - x[i])) + 1.0) / 9.0;
        }
    }

    public static void f02_f1(int n, double[] x, double[] y, ref double[] fx, ref double[] fy)
        //****************************************************************************80
        //
        //  Purpose:
        //
        ...
        //
    {
        for (int i = 0; i < n; i++)
        {
            double t1 = 18.0 * (y[i] - x[i]);
            fx[i] = -4.0 / (Math.Exp(t1) + 2.0 + Math.Exp(-t1));
            fy[i] = -fx[i];
        }
    }

    public static void f02_f2(int n, double[] x, double[] y, ref double[] fxx, ref double[] fxy,
            ref double[] fyy)
        //****************************************************************************80
        //
        //  Purpose:
        ...
        //
    {
        for (int i = 0; i < n; i++)
        {
            ...
            fxx[i] = 18.0 * Math.Tanh(0.5 * t1)
                          * (Math.Tanh(9.0 * (y[i] - x[i])) + 1.0) / 9.0;
            fxy[i] = -fxx[i];
            fyy[i] = fxx[i];
        }
    }

    public static string f02_title()
        //****************************************************************************80
        //
        //  Purpose:
        //
    ...
    public static void f03_f0(int n, double[] x, double[] y, ref double[] f)
        //****************************************************************************80
        //
        //  Purpose:
        //
        ...
        //
    {
        for (int i = 0; i < n; i++)
        {
            f[i] = (1.25 + Math.Cos(5.4 * y[i]))
                   / (6.0 + 6.0 * Math.Pow(3.0 * x[i] - 1.0, 2));
        }
    }

    public static void f03_f1(int n, double[] x, double[] y, ref double[] fx, ref double[] fy)
        //****************************************************************************80
        //
        //  Purpose:
        //
        ...
        //
    {
        ...
        {
            double t1 = 5.4 * y[i];
            double t2 = 1.0 + Math.Pow(3.0 * x[i] - 1.0, 2);
            fx[i] = -(3.0 * x[i] - 1.0) * (1.25 + Math.Cos(t1)) / (t2 * t2);
            fy[i] = -0.9 * Math.Sin(t1) / t2;
        }

    }

    public static void f03_f2(int n, double[] x, double[] y, ref double[] fxx, ref double[] fxy,
            ref double[] fyy)
        //****************************************************************************80
        //
        //  Purpose:
        ...
        //
    {
        for (int i = 0; i < n; i++)
        {
            ...
            fxx[i] = 3.0 * (1.25 + Math.Cos(t1)) * (3.0 * t2 - 4.0) / Math.Pow(t2, 3);
            fxy[i] = 5.4 * (3.0 * x[i] - 1.0) * Math.Sin(t1) / (t2 * t2);
            fyy[i] = -4.86 * Math.Cos(t1) / t2;
        }
    }

    public static string f03_title()
        //****************************************************************************80
        //
        //  Purpose:
        //
    ...
    public static void f04_f0(int n, double[] x, double[] y, ref double[] f)
        //****************************************************************************80
        //
        //  Purpose:
        //
        ...
        //
    {
        for (int i = 0; i < n; i++)
        {
            f[i] = Math.Exp(-5.0625 * (Math.Pow(x[i] - 0.5, 2)
                                       + Math.Pow(y[i] - 0.5, 2))) / 3.0;
        }
    }

    public static void f04_f1(int n, double[] x, double[] y, ref double[] fx, ref double[] fy)
        //****************************************************************************80
        //
        //  Purpose:
        //
        ...
        //
    {
        for (int i = 0; i < n; i++)
        {
            double t1 = x[i] - 0.5;
            double t2 = y[i] - 0.5;
            double t3 = -3.375 * Math.Exp(-5.0625 * (t1 * t1 + t2 * t2));
            fx[i] = t1 * t3;
            fy[i] = t2 * t3;
        }
    }

    public static void f04_f2(int n, double[] x, double[] y, ref double[] fxx, ref double[] fxy,
            ref double[] fyy)
        //****************************************************************************80
        //
        //  Purpose:
    ...
    public static string f04_title()
        //****************************************************************************80
        //
        //  Purpose:
        //
    ...
    public static void f05_f0(int n, double[] x, double[] y, ref double[] f)
        //****************************************************************************80
        //
        //  Purpose:
        //
        ...
        //
    {
        for (int i = 0; i < n; i++)
        {
            f[i] = Math.Exp(-20.25 * (Math.Pow(x[i] - 0.5, 2)
                                      + Math.Pow(y[i] - 0.5, 2))) / 3.0;
        }
    }

    public static void f05_f1(int n, double[] x, double[] y, ref double[] fx, ref double[] fy)
        //****************************************************************************80
        //
        //  Purpose:
        //
        ...
        //
    {
        for (int i = 0; i < n; i++)
        {
            double t1 = x[i] - 0.5;
            double t2 = y[i] - 0.5;
            double t3 = -13.5 * Math.Exp(-20.25 * (t1 * t1 + t2 * t2));
            fx[i] = t1 * t3;
            fy[i] = t2 * t3;
        }
    }

    public static void f05_f2(int n, double[] x, double[] y, ref double[] fxx, ref double[] fxy,
            ref double[] fyy)
        //****************************************************************************80
        //
        //  Purpose:
    ...
    public static string f05_title()
        //****************************************************************************80
        //
        //  Purpose:
        //
    ...
    public static void f06_f0(int n, double[] x, double[] y, ref double[] f)
        //****************************************************************************80
        //
        //  Purpose:
        //
        ...
        //
    {
        for (int i = 0; i < n; i++)
        {
            double t4 = 64.0 - 81.0 * (Math.Pow(x[i] - 0.5, 2) + Math.Pow(y[i] - 0.5, 2));

            f[i] = t4 switch
            {
                >= 0.0 => Math.Sqrt(t4) / 9.0 - 0.5,
                _ => 0.0
            };
        }
    }

    public static void f06_f1(int n, double[] x, double[] y, ref double[] fx, ref double[] fy)
        //****************************************************************************80
        //
        //  Purpose:
        //
    ...
    public static void f06_f2(int n, double[] x, double[] y, ref double[] fxx, ref double[] fxy,
            ref double[] fyy)
        //****************************************************************************80
        //
        //  Purpose:
    ...
    public static string f06_title()
        //****************************************************************************80
        //
        //  Purpose:
        //
    ...
    public static void f07_f0(int n, double[] x, double[] y, ref double[] f)
        //****************************************************************************80
        //
        //  Purpose:
        //
        ...
        //
    {
        for (int i = 0; i < n; i++)
        {
            f[i] = 2.0 * Math.Cos(10.0 * x[i]) * Math.Sin(10.0 * y[i])
                   + Math.Sin(10.0 * x[i] * y[i]);
        }
    }

    public static void f07_f1(int n, double[] x, double[] y, ref double[] fx, ref double[] fy)
        //****************************************************************************80
        //
        //  Purpose:
        //
        ...
        //
    {
        for (int i = 0; i < n; i++)
        {
            double t1 = 10.0 * x[i];
            double t2 = 10.0 * y[i];
            double t3 = 10.0 * Math.Cos(10.0 * x[i] * y[i]);
            fx[i] = -20.0 * Math.Sin(t1) * Math.Sin(t2) + t3 * y[i];
            fy[i] = 20.0 * Math.Cos(t1) * Math.Cos(t2) + t3 * x[i];
        }
    }

    public static void f07_f2(int n, double[] x, double[] y, ref double[] fxx, ref double[] fxy,
            ref double[] fyy)
        //****************************************************************************80
        //
        //  Purpose:
        ...
        //
    {
        for (int i = 0; i < n; i++)
        {
            ...
            double t2 = 10.0 * y[i];
            double t3 = 10.0 * Math.Cos(10.0 * x[i] * y[i]);
            double t4 = 100.0 * Math.Sin(10.0 * x[i] * y[i]);

            fxx[i] = -200.0 * Math.Cos(t1) * Math.Sin(t2) - t4 * y[i] * y[i];
            fxy[i] = -200.0 * Math.Sin(t1) * Math.Cos(t2) + t3 - t4 * x[i] * y[i];
            fyy[i] = -200.0 * Math.Cos(t1) * Math.Sin(t2) - t4 * x[i] * x[i];
        }
    }

    public static string f07_title()
        //****************************************************************************80
        //
        //  Purpose:
        //
    ...
    public static void f08_f0(int n, double[] x, double[] y, ref double[] f)
        //****************************************************************************80
        //
        //  Purpose:
        //
        ...
        //
    {
        for (int i = 0; i < n; i++)
        {
            double t1 = 5.0 - 10.0 * x[i];
            double t2 = 5.0 - 10.0 * y[i];
            double t3 = Math.Exp(-0.5 * t1 * t1);
            double t4 = Math.Exp(-0.5 * t2 * t2);
            f[i] = t3 + 0.75 * t4 * (1.0 + t3);
        }
    }

    public static void f08_f1(int n, double[] x, double[] y, ref double[] fx, ref double[] fy)
        //****************************************************************************80
        //
        //  Purpose:
        //
    ...
    public static void f08_f2(int n, double[] x, double[] y, ref double[] fxx, ref double[] fxy,
            ref double[] fyy)
        //****************************************************************************80
        //
        //  Purpose:
    ...
    public static string f08_title()
        //****************************************************************************80
        //
        //  Purpose:
        //
        ...
        //
    {
        string ft = "Synergistic Gaussian";

        return ft;
    }

    public static void f09_f0(int n, double[] x, double[] y, ref double[] f)
        //****************************************************************************80
        //
        //  Purpose:
        //
    ...
    public static void f09_f1(int n, double[] x, double[] y, ref double[] fx, ref double[] fy)
        //****************************************************************************80
        //
        //  Purpose:
        //
        ...
        //
    {
        ...
        for (i = 0; i < n; i++)
        {
            ...
            fy[i] = Math.Pow(20.0 / 3.0 * t1, 2) * Math.Pow(20.0 / 3.0 * t3, 5)
    ...
    public static void f09_f2(int n, double[] x, double[] y, ref double[] fxx, ref double[] fxy,
            ref double[] fyy)
        //****************************************************************************80
        //
        //  Purpose:
    ...
    public static string f09_title()
        //****************************************************************************80
        //
        //  Purpose:
        //
        ...
        //
    {
        string ft = "Cloverleaf Asymmetric Peak/Valley";

        return ft;
    }

    public static void f10_f0(int n, double[] x, double[] y, ref double[] f)
        //****************************************************************************80
        //
        //  Purpose:
        //
    ...
    public static void f10_f1(int n, double[] x, double[] y, ref double[] fx, ref double[] fy)
        //****************************************************************************80
        //
        //  Purpose:
        //
    ...
    public static void f10_f2(int n, double[] x, double[] y, ref double[] fxx, ref double[] fxy,
            ref double[] fyy)
        //****************************************************************************80
        //
        //  Purpose:
            ...
            switch (t1)
            {
                ...
                default:
                    ...
                    fyy[i] = t5 * (t1 * (97.2 * t4 - 169.29 * t3)
                                      * Math.Pow(90.0 * y[i] - 45.0, 2) - (1215.0 * t4 + 324.0 * t3)
                        * Math.Pow(80.0 * x[i] - 40.0, 2));
                    break;
            }
        }
    ...
    public static string f10_title()
        //****************************************************************************80
        //
        //  Purpose:
        //
        ...
        //
    {
        string ft = "Cosine Peak";

        return ft;
    }

    public static void f11_f0(int n, double[] x, double[] y, ref double[] f)
        //****************************************************************************80
        //
        //  Purpose:
        //
    ...
    public static void f11_f1(int n, double[] x, double[] y, ref double[] fx, ref double[] fy)
        //****************************************************************************80
        //
        //  Purpose:
        //
    ...
    public static void f11_f2(int n, double[] x, double[] y, ref double[] fxx, ref double[] fxy,
            ref double[] fyy)
        //****************************************************************************80
        //
        //  Purpose:
    ...
    public static string f11_title()
        //****************************************************************************80
        //
        //  Purpose:
        //
        ...
        //
    {
        string ft = "Bilinear function";

        return ft;
    }

    public static void f12_f0(int n, double[] x, double[] y, ref double[] f)
        //****************************************************************************80
        //
        //  Purpose:
        //
    ...
    public static void f12_f1(int n, double[] x, double[] y, ref double[] fx, ref double[] fy)
        //****************************************************************************80
        //
        //  Purpose:
        //
    ...
    public static void f12_f2(int n, double[] x, double[] y, ref double[] fxx, ref double[] fxy,
            ref double[] fyy)
        //****************************************************************************80
        //
        //  Purpose:
    ...
    public static string f12_title()
        //****************************************************************************80
        //
        //  Purpose:
        //
    ...
    public static void f13_f0(int n, double[] x, double[] y, ref double[] f)
        //****************************************************************************80
        //
        //  Purpose:
        //
        ...
        //
    {
        ...
        for (i = 0; i < n; i++)
        {
            f[i] = 1.0 / (Math.Pow(10.0 * x[i] - 5.0, 2)
                          + Math.Pow(10.0 * y[i] - 5.0, 2) + 1.0);
        }
    }

    public static void f13_f1(int n, double[] x, double[] y, ref double[] fx, ref double[] fy)
        //****************************************************************************80
        //
        //  Purpose:
        //
    ...
    public static void f13_f2(int n, double[] x, double[] y, ref double[] fxx, ref double[] fxy,
            ref double[] fyy)
        //****************************************************************************80
        //
        //  Purpose:
    ...
    public static string f13_title()
        //****************************************************************************80
        //
        //  Purpose:
        //
    ...
    public static int g00_size(int gi)
        //****************************************************************************80
        //
        //  Purpose:
        //
        ...
        //
    {
        ...
        switch (gi)
        {
            ...
            default:
                Console.WriteLine();
                Console.WriteLine("G00_SIZE - Fatal error!");
                Console.WriteLine("  Illegal grid index GI = " + gi + "");
                break;
        }
    ...
    public static string g00_title(int gi)
        //****************************************************************************80
        //
        //  Purpose:
        //
        ...
        //
    {
        ...
        switch (gi)
        {
            ...
            default:
                Console.WriteLine("");
                Console.WriteLine("G00_TITLE - Fatal error!");
                Console.WriteLine("  Illegal grid index GI = " + gi + "");
                break;
        }
    ...
    public static void g00_xy(int gi, int gn, ref double[] gx, ref double[] gy)
        //****************************************************************************80
        //
        //  Purpose:
        //
        ...
        //
    {
        ...
        {
            case 1:
                g01_xy(gn, ref gx, ref gy);
                break;
            case 2:
                g02_xy(gn, ref gx, ref gy);
                break;
            case 3:
                g03_xy(gn, ref gx, ref gy);
                break;
            case 4:
                g04_xy(gn, ref gx, ref gy);
                break;
            case 5:
                g05_xy(gn, ref gx, ref gy);
                break;
            default:
                Console.WriteLine("");
                Console.WriteLine("G00_XY - Fatal error!");
                Console.WriteLine("  Illegal grid index GI = " + gi + "");
                break;
        }
    }

    public static int g01_size()
        //****************************************************************************80
        //
        //  Purpose:
        //
    ...
    public static string g01_title()
        //****************************************************************************80
        //
        //  Purpose:
        //
    ...
    public static void g01_xy(int gn, ref double[] gx, ref double[] gy)
        //****************************************************************************80
        //
        //  Purpose:
        //
    ...
    public static string g02_title()
        //****************************************************************************80
        //
        //  Purpose:
        //
    ...
    public static void g02_xy(int gn, ref double[] gx, ref double[] gy)
        //****************************************************************************80
        //
        //  Purpose:
        //
    ...
    public static string g03_title()
        //****************************************************************************80
        //
        //  Purpose:
        //
    ...
    public static void g03_xy(int gn, ref double[] gx, ref double[] gy)
        //****************************************************************************80
        //
        //  Purpose:
        //
    ...
    public static string g04_title()
        //****************************************************************************80
        //
        //  Purpose:
        //
    ...
    public static void g04_xy(int gn, ref double[] gx, ref double[] gy)
        //****************************************************************************80
        //
        //  Purpose:
        //
    ...
    public static string g05_title()
        //****************************************************************************80
        //
        //  Purpose:
        //
    ...
    public static void g05_xy(int gn, ref double[] gx, ref double[] gy)
        //****************************************************************************80
        //
        //  Purpose:
        //
