...
namespace Newton1DTest
{
    class Program
    {
        ...
        static void newton_coef_1d_test()
        ...
        static void newton_value_1d_test()
        ...
        static void newton_interp_1d_test01(int prob)
            ...
            //
        {
            ...
            interp_error = typeMethods.r8vec_norm_affine(ni, yi, yd) / (double) (ni);
