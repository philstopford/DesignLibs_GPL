...
namespace RBFInterpnDTest
{
    class Program
    {
        ...
        static void rbf_interp_nd_test01()
            ...
            //
        {
            ...
            int_error = typeMethods.r8vec_norm_affine(nd, fd, fi) / (double) (nd);
            ...
            app_error = Math.Pow(b - a, m) * typeMethods.r8vec_norm_affine(ni, fi, fe) / (double) (ni);
        ...
        static void rbf_interp_nd_test02()
        ...
        static void rbf_interp_nd_test03()
        ...
        static void rbf_interp_nd_test04()
