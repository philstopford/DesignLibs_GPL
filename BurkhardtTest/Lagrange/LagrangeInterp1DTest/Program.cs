...
namespace LagrangeInterp1DTest
{
    class Program
    {
        ...
        static void test01(int prob, int nd)
            ...
            //
        {
            ...
            for (i = 0; i < nd - 1; i++)
            {
                ld = ld + Math.Sqrt(Math.Pow((xd[i + 1] - xd[i]) / (b - a), 2)
            ...
            for (i = 0; i < ni - 1; i++)
            {
                li = li + Math.Sqrt(Math.Pow((xi[i + 1] - xi[i]) / (b - a), 2)
        ...
        static void test02(int prob, int nd)
