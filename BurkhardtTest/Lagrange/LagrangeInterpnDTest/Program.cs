    ...
    class Program
    {
            ...
            //
        {
            ...
            for (l = 1; l <= 5; l++)
            {
                ...
                e = typeMethods.r8vec_norm_affine(ni, zi, ze) / (double) (ni);
        ...
        static double[] f_sinr(int m, int n, double[] x)
        ...
        static double[] f_poly352(int m, int n, double[] x)
