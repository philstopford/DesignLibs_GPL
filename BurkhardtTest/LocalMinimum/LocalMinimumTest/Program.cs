...
namespace LocalMinimumTest
{
    class Program
    {
        ...
        static void local_min_example(double a, double b, Func<double, double> f,
                string title)
