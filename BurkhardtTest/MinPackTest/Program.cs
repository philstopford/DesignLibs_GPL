...
namespace MinPackTest
{
    class Program
    {
        ...
        static void chkder_f(int n, double[] x, double[] fvec, double[] fjac, int ldfjac,
        ref int iflag )
        ...
        static fcnData hybrd1_f(int n, double[] x, double[] fvec, int iflag, int arrayIndex, int array2Index )
        //****************************************************************************80
        //
        //  Purpose:
        //
