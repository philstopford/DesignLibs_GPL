...
namespace NavierStokes2DExactTest
{
    class Program
    {
        ...
        static void gnuplot_lukas_test()
        ...
        static void uvp_poiseuille_test()
        ...
        static void uvp_poiseuille_test2()
        ...
        static void rhs_poiseuille_test()
        ...
        static void resid_poiseuille_test()
        ...
        static void gnuplot_poiseuille_test()
        ...
        static void parameter_poiseuille_test()
            ...
            //
        {
            ...
            for (j = 1; j <= 3; j++)
            {
                for (k = 0; k <= 5; k++)
                {
                    ...
                    u_norm = typeMethods.r8vec_norm_l2(n, u) / (double) (n);
                    v_norm = typeMethods.r8vec_norm_l2(n, v) / (double) (n);
                    p_norm = typeMethods.r8vec_norm_l2(n, p) / (double) (n);
        ...
        static void gnuplot_spiral_test()
        ...
        static void parameter_spiral_test()
        ...
        static void gnuplot_taylor_test()
        ...
        static void parameter_taylor_test()
        ...
        static void gnuplot_vortex_test()
        ...
        static void parameter_vortex_test()
