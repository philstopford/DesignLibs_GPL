...
internal static class Program
{
    ...
    private static void predator_prey_midpoint_fixed_test(double[] tspan, double[] p0, int n)

        //****************************************************************************80
        //
        //  Purpose:
        //
        //    predator_prey_midpoint_fixed_test solves predator-prey ODE using midpoint_fixed().
        //
        //  Discussion:
        //
        ...
        //
    {
        ...
        const string header = "predator_prey_midpoint_fixed";
        int i;
        const int m = 2;

        Console.WriteLine("");
        Console.WriteLine("predator_prey_midpoint_fixed_test");
        ...
        Console.WriteLine("");
        Console.WriteLine("  predator_prey_midpoint_fixed_test: data stored in '" + data_filename + "'.");
        //
        ...
        command.Add("set title 'Predator prey: midpoint fixed'");
    ...
    private static double[] stiff_deriv(double t, double[] y, int yIndex)
    ...
    private static double[] stiff_exact(int n, double[] t)
    ...
    private static void stiff_midpoint_fixed_test(double[] tspan, double[] y0, int n)

        //****************************************************************************80
        //
        //  Purpose:
        //
        //    stiff_midpoint_fixed_test() uses midpoint_fixed()  on the stiff ODE.
        //
        //  Licensing:
        //
        //    This code is distributed under the GNU LGPL license.
        ...
        //
    {
        ...
        Console.WriteLine("");
        Console.WriteLine("stiff_midpoint_fixed_test");
        Console.WriteLine("  Solve stiff ODE using midpoint_fixed().");
    ...
    private static void plot2(int n1, double[] t1, double[] y1, int n2, double[] t2,
