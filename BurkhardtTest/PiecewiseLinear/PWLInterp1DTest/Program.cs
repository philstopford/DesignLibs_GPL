...
namespace PWLInterp1DTest
{
    class Program
    {
        ...
        static void pwl_interp_1d_test01(int prob)
            ...
            //
        {
            ...
            interp_error = typeMethods.r8vec_diff_norm(ni, yi, yd) / (double)(ni);
