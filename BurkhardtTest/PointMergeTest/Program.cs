...
namespace PointMergeTest
{
    class Program
    {
        ...
        static void test01(int m, int n, int n_unique, int seed)
        ...
        static void test02(int m, int n, int n_unique, double tol, int seed)
        ...
        static void test03(int m, int n, int n_unique, double tol, int seed)
        ...
        static void test04(int m, int n, int n_unique, double tol, int seed)
            ...
            //
        {
            ...
            for (j = 0; j < n; j++)
            {
                ...
                if (j != k)
                {
                    ...
                    for (i = 0; i < m; i++)
                    {
                        dist = dist + Math.Pow(a[i + j * m] - a[i + k * m], 2);
                    }
        ...
        static void test05(int m, int n, int n_unique, double tol, int seed)
