...
internal class Program
{
    ...
    private static void polyomino_condense_test()
    ...
    private static void polyomino_enumerate_test()
    ...
    private static void polyomino_enumerate_chiral_test()
    ...
    private static void polyomino_enumerate_fixed_test()
    ...
    private static void polyomino_monohedral_example_reid_size(ref int m, ref int n)
    ...
    private static void polyomino_monohedral_example_reid_system(int m, int n, int[] a, int[] b)
