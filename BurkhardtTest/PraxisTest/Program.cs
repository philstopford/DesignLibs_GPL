...
namespace PraxisTest
{
    class Program
    {
        ...
        static double beale_f(double[] x, int n)
        ...
        static double box_f(double[] x, int n)
        ...
        static double chebyquad_f(double[] x, int n)
        ...
        static double cube_f(double[] x, int n)
        ...
        static double helix_f(double[] x, int n)
            ...
            //
        {
            ...
            if (0.0 <= x[0])
            {
                theta = 0.5 * Math.Atan2(x[1], x[0]) / Math.PI;
            }
            else if (x[0] < 0.0)
            {
                theta = 0.5 * (Math.Atan2(x[1], x[0]) + Math.PI) / Math.PI;
            }
        ...
        static double hilbert_f(double[] x, int n)
        ...
        static double powell3d_f(double[] x, int n)
        ...
        static double rosenbrock_f(double[] x, int n)
        ...
        static double singular_f(double[] x, int n)
        ...
        static double tridiagonal_f(double[] x, int n)
        ...
        static double watson_f(double[] x, int n)
            ...
            //
        {
            ...
            for (i = 1; i <= 29; i++)
            {
                ...
                value = value + Math.Pow(s1 - s2 * s2 - 1.0, 2);
            }
        ...
        static double wood_f(double[] x, int n)
