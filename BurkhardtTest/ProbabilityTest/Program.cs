...
static void beta_binomial_sample_test()
...
static void binomial_sample_test()
...
static void bradford_sample_test()
...
Console.WriteLine("  " + setw(8) + trial_num
+ "  " + setw(8) + hits
+ "  " + setw(14) + pi_est
+ "  " + setw(14) + err + "");
}
...
static void chebyshev1_cdf_test()
...
static void chebyshev1_sample_test()
...
static void chi_square_cdf_test()
...
static void chi_square_sample_test()
...
static void chi_square_noncentral_sample_test()
...
static void cosine_sample_test()
...
static void deranged_sample_test()
...
int seed = 123456789;
int test_i;
double test_a[TEST_NUM] =  {
0.0, PI / 4.0, PI / 2.0
}
;
double test_b[TEST_NUM] =  {
1.0, 0.5, 0.0
}
;
double x;
...
static void dipole_sample_test()
...
static void discrete_sample_test()
