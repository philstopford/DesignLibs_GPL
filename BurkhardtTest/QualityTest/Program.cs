...
internal class Program
{
    ...
    private static void test_halton()
    ...
    private static void test_sphere()
    ...
    private static void test005(int n, double[] z, int nt, int[] triangle)
    ...
    private static void test006(int n, double[] z, int nt, int[] triangle)
    ...
    private static void test007(int dim_num, int n, double[] z)
    ...
    private static void test01(int dim_num, int n, double[] z, int ns,
    ...
    private static void test02(int dim_num, int n, double[] z, int ns,
            Func<int, int, int, GeometrySampleResult> sample_routine, int seed_init)
    ...
    private static void test03(int dim_num, int n, double[] z, int ns,
            Func<int, int, int, GeometrySampleResult> sample_routine, int seed_init)
    ...
    private static void test04(int dim_num, int n, double[] z)
    ...
    private static void test05(int dim_num, int n, double[] z, int ns,
            Func<int, int, int, GeometrySampleResult> sample_routine, int seed_init)
    ...
    private static void test06(int dim_num, int n, double[] z)
    ...
    private static void test07(int dim_num, int n, double[] z, int ns,
            Func<int, int, int, GeometrySampleResult> sample_routine, int seed_init)
    ...
    private static void test08(int dim_num, int n, double[] z, int ns,
            Func<int, int, int, GeometrySampleResult> sample_routine, int seed_init)
    ...
    private static void test083(int n, double[] z, int nt, int[] triangle)
    ...
    private static void test085(int dim_num, int n, double[] z)
    ...
    private static void test09(int dim_num, int n, double[] z)
    ...
    private static void test10(int dim_num, int n, double[] z, int ns,
            Func<int, int, int, GeometrySampleResult> sample_routine, int seed_init)
