...
namespace QuaternionsTest
{
    class Program
    {
        ...
        static void q8_exponentiate_test()
        ...
        static void q8_transpose_print_test()
        ...
        static void r8mat_print_some_test()
        ...
        static void r8vec_uniform_01_new_test()
...
# undef N
        ...
        static void rotation_axis2mat_test()
            ...
            //
        {
            ...
            a = Rotation.rotation_axis2mat(axis1, angle);

            typeMethods.r8mat_print(3, 3, a, "  The rotation matrix A:");

            w = typeMethods.r8mat_mv_new(3, 3, a, v1);
        ...
        static void rotation_axis2quat_test()
        ...
        static void rotation_axis_vector_test()
        ...
        static void rotation_mat2axis_test()
            ...
            //
        {
            ...
            a2 = Rotation.rotation_axis2mat(axis, angle);

            typeMethods.r8mat_print(3, 3, a, "  The recovered rotation matrix:");

        }

        static void rotation_mat2quat_test()
        ...
        static void rotation_mat_vector_test()
        ...
        static void rotation_quat2axis_test()
        ...
        static void rotation_quat2mat_test()
        ...
        static void rotation_quat_vector_test()
