...
namespace ReactorSimulation
{
    class Program
    {
        ...
        static bool absorb(ref int seed)
        ...
        static double dist2c(double e, ref int seed)
        ...
        static double energy(ref int seed)
        ...
        static void output(int na, double ea, double sa, int nr, double er, double sr,
            ...
            //
        {
            ...
            {
                ea_ave = ea / (double)(na);
                sa = Math.Sqrt(sa / (double)(na) - ea_ave * ea_ave);
            }
            else
            {
                ea_ave = 0.0;
            ...
            {
                er_ave = er / (double)(nr);
                sr = Math.Sqrt(sr / (double)(nr) - er_ave * er_ave);
            }
            else
            {
                er_ave = 0.0;
            ...
            {
                et_ave = et / (double)(nt);
                st = Math.Sqrt(st / (double)(nt) - et_ave * et_ave);
            }
            else
            {
                et_ave = 0.0;
        ...
        static void scatter(ref int seed, ref double e, ref double mu, ref double azm)
        ...
        static void source(ref int seed, ref double e, ref double mu, ref double azm, ref double x,
        ...
        static void update(double mu, double azm, double d, ref double x, ref double y, ref double z)
            ...
            //
        {
            ...
            x = x + d * mu;
            y = y + d * s * Math.Cos(azm);
            z = z + d * s * Math.Sin(azm);
