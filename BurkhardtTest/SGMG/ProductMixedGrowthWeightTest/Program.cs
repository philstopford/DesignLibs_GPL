...
namespace ProductMixedGrowthWeightTest
{
    class Program
    {
        ...
        static void product_mixed_growth_weight_tests()
        ...
        static void product_mixed_growth_weight_test(int dim_num, int[] order_1d,
            ...
            //
        {
            ...
            for (dim = 0; dim < dim_num; dim++)
            {
                ...
                {
                    weight_sum_exact = weight_sum_exact * Math.Sqrt(Math.PI);
                }
                else if (rule[dim] == 6)
                {
                    alpha = p[p_index];
                    ...
                    weight_sum_exact = weight_sum_exact
                                       * typeMethods.r8_gamma(0.5 * (alpha + 1.0));
                }
                else if (rule[dim] == 7)
                {
                ...
                else if (rule[dim] == 8)
                {
                    ...
                    weight_sum_exact = weight_sum_exact * typeMethods.r8_gamma(alpha + 1.0);
                }
                else if (rule[dim] == 9)
                {
                    alpha = p[p_index];
