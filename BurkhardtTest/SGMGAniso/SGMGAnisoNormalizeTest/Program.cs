...
namespace SGMGAnisoNormalizeTest
{
    class Program
    {
        ...
        static void sgmga_aniso_balance_tests()
        ...
        static void sgmga_aniso_balance_test(double alpha_max, int dim_num,
                double[] level_weight)
        ...
        static void sgmga_aniso_normalize_tests()
        ...
        static void sgmga_aniso_normalize_test(int dim_num, double[] level_weight)
        ...
        static void sgmga_importance_to_aniso_tests()
        ...
        static void sgmga_importance_to_aniso_test(int dim_num, double[] importance,
                double[] level_weight)
