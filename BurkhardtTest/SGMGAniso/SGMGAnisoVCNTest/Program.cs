    ...
    class Program
    {
            ...
            //
        {
            ...
            for (test = 0; test < test_num; test++)
            {
                ...
                q_min = (double) (level_max) - typeMethods.r8vec_sum(dim_num, level_weight);
        ...
        static void sgmga_vcn_test(int dim_num, double[] importance, double[] level_weight,
            ...
            //
        {
            ...
            double q;
            int test;
            SGMGAniso.SGMGAData data = new SGMGAniso.SGMGAData();
            string cout = "";
        ...
        static void sgmga_vcn_timing_tests()
        ...
        static void sgmga_vcn_timing_test(int dim_num, double[] importance,
        ...
        static void sgmga_vcn_ordered_tests()
        ...
        static void sgmga_vcn_ordered_test(int dim_num, double[] importance,
                double[] level_weight, double q_min, double q_max)
