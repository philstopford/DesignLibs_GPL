...
namespace SandiaCubatureTest
{
    class Program
    {
        ...
        static void cn_geg_test(int n, double alpha, int[] expon)
        ...
        static void cn_jac_test(int n, double alpha, double beta, int[] expon)
        ...
        static void cn_leg_test(int n, int[] expon)
        ...
        static void en_her_test(int n, int[] expon)
        ...
        static void epn_glg_test(int n, int[] expon, double alpha)
        ...
        static void epn_lag_test(int n, int[] expon)
