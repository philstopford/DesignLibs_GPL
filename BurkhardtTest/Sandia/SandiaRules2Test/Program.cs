...
namespace SandiaRules2Test
{
    class Program
    {
        ...
        static JacobiQuadrature.ParameterData parameter(JacobiQuadrature.ParameterData data, int dim, int offset)
            ...
            //
        {
            ...
            double[] x1;
            double[] x2;
            JacobiQuadrature.ParameterData data = new JacobiQuadrature.ParameterData();
