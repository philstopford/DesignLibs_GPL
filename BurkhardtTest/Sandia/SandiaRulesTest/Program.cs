...
internal static class Program
{
        ...
        //
    {
        ...
        for (order = 1; order <= order_max; order++)
        {
            ...
            {
                double exact = Integral.chebyshev1_integral(n);
                ...
                double error = typeMethods.r8_abs(exact - estimate);
        ...
        //
    {
        ...
        for (order = 1; order <= order_max; order++)
        {
            ...
            for (n = 0; n <= 2 * order + 2; n += 1)
            {
                double exact = Integral.chebyshev2_integral(n);
        ...
        //
    {
        ...
        for (order = 1; order <= order_max; order++)
        {
            ...
            for (n = 0; n <= n_hi; n += 1)
            {
                double exact = Integral.legendre_integral(n);
        ...
        //
    {
        ...
        for (test = 0; test < TEST_NUM; test++)
        {
            ...
            for (order = 1; order <= order_max; order++)
            {
                ...
                for (n = 0; n <= 2 * order + 2; n += 1)
                {
                    double exact = Integral.gegenbauer_integral(n, alpha);
        ...
        //
    {
        ...
        for (test = 0; test < TEST_NUM; test++)
        {
            ...
            for (order = 1; order <= order_max; order++)
            {
                ...
                for (n = 0; n <= 2 * order + 2; n += 1)
                {
                    double exact = Integral.gen_hermite_integral(n, alpha);
        ...
        //
    {
        ...
        for (test = 0; test < TEST_NUM; test++)
        {
            ...
            for (order = 1; order <= order_max; order++)
            {
                ...
                for (n = 0; n <= 2 * order + 2; n += 1)
                {
                    double exact = Integral.gen_laguerre_integral(n, alpha);
        ...
        //
    {
        ...
        for (n = 1; n <= N_MAX; n++)
        {
            ...
            for (d = 0; d <= 2 * n + 2; d += 1)
            {
                double exact = Integral.hermite_integral(d);
        ...
        for (test1 = 0; test1 < TEST_NUM; test1++)
        {
            ...
            for (test2 = 0; test2 < TEST_NUM; test2++)
            {
                ...
                for (order = 1; order <= order_max; order++)
                {
                    ...
                    for (n = 0; n <= 2 * order + 2; n += 1)
                    {
                        double exact = Integral.jacobi_integral(n, alpha, beta);
        ...
        //
    {
        ...
        for (order = 1; order <= order_max; order++)
        {
            ...
            for (n = 0; n <= 2 * order + 2; n += 1)
            {
                double exact = Integral.laguerre_integral(n);
        ...
        //
    {
        ...
        for (order = 1; order <= order_max; order++)
        {
            ...
            for (n = 0; n <= 2 * order + 2; n += 1)
            {
                double exact = Integral.hermite_integral(n);
        ...
        //
    {
        ...
        int[] level = new int[dim_num];
        int[] order = new int[dim_num];
        ...
        //
    {
        ...
        int n_unique = typeMethods.r8col_tol_unique_count(M, N, a, tol);

        Console.WriteLine("");
        Console.WriteLine("  Number of tolerably unique columns is " + n_unique + "");

        double[] au = new double[M * n_unique];
        int[] undx = new int[n_unique];
        int[] xdnu = new int[N];
        ...
        //
    {
        ...
        int[] indx = typeMethods.r8vec_sort_heap_index_a_new(n, a);
        ...
        //
    {
        ...
        for (n = 2; n <= 11; n++)
        {
            ...
            double error = typeMethods.r8_abs(q - exact);
            Console.WriteLine("  " + n.ToString().PadLeft(4)
        ...
        for (n = 5; n <= 21; n += 4)
        {
            ...
            for (e = 0; e <= 15; e++)
            {
                ...
                exact = (Math.Pow(b, e + 1) - Math.Pow(a, e + 1)) / (e + 1);
        ...
        //
    {
        ...
        for (rule = 0; rule < 8; rule++)
        {
            ...
            double s = typeMethods.r8vec_sum(o, w);
