...
namespace SandiaSparseTest
{
    class Program
    {
        ...
        static void levels_index_size_test(int rule, int dim_min, int dim_max,
        ...
        static void levels_index_test(int rule, int dim_num, int level_max)
        ...
        static void sparse_grid_compute_test(int rule, int dim_num, int level_max)
        ...
        static void sparse_grid_weight_test(int rule, int dim_num, int level_max)
            ...
            //
        {
            ...
            {
                weight_sum_exact = Math.Sqrt(Math.Pow(pi, dim_num));
            }
            else if (7 == rule)
            {
        ...
        static void sparse_grid_monomial_test(int rule, int dim_num, int level_max,
                int degree_max)
