...
namespace MolecularDynamics
{
    class Program
    {
            ...
            for (k = 0; k < np; k++)
            {
                ...
                for (j = 0; j < np; j++)
                {
                    if (k != j)
                    {
                        ...
                        pot = pot + 0.5 * Math.Pow(Math.Sin(d2), 2);
        ...
        static double dist(int nd, double[] r1, double[] r2, ref double[] dr)
        ...
        static void initialize(int np, int nd, ref double[] pos, ref double[] vel, ref double[] acc)
        ...
        static void update(int np, int nd, ref double[] pos, ref double[] vel, double[] f,
