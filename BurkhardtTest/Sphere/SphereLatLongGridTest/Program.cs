...
namespace SphereLatLongGridTest
{
    class Program
    {
        ...
        static void sphere_llq_grid_point_count_test()
            ...
            //
        {
            ...
            for (lat_num = 1; lat_num <= 17; lat_num = lat_num + 2)
            {
                ...
                {
                    long_num = long_num * 2;
                    point_num = Grid_LatLong.sphere_llq_grid_point_count(lat_num, long_num);
        ...
        static void sphere_llq_grid_points_test()
            ...
            //
        {
            ...
            node_num = Grid_LatLong.sphere_llq_grid_point_count(lat_num, long_num);

            Console.WriteLine("");
            Console.WriteLine("  The number of grid points is " + node_num + "");

            node_xyz = Grid_LatLong.sphere_llq_grid_points(r, pc, lat_num, long_num, node_num);
        ...
        static void sphere_llq_grid_line_count_test()
            ...
            //
        {
            ...
            for (lat_num = 1; lat_num <= 17; lat_num = lat_num + 2)
            {
                ...
                {
                    long_num = long_num * 2;
                    line_num = Grid_LatLong.sphere_llq_grid_line_count(lat_num, long_num);
                    Console.WriteLine("  " + lat_num.ToString().PadLeft(8)
                                           + "  " + long_num.ToString().PadLeft(8)
        ...
        static void sphere_llq_grid_lines_test()
            ...
            //
        {
            ...
            line_data = Grid_LatLong.sphere_llq_grid_lines(lat_num, long_num, line_num);
        ...
        static void sphere_llq_grid_display_test()
