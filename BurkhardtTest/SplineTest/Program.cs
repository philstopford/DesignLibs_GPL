...
namespace SplineTest
{
    ...
    class Program
    {
        ...
        static void parabola_val2_test()
            ...
            //
        {
            ...
            for (i = 0; i < NTAB; i++)
            {
                xtab[i] = ((double)(NTAB - i - 1) * (-1.0)
                           + (double)(i) * (+1.0))
                          / (double)(NTAB - 1);
                ytab[i] = (double)((int)(Math.Exp(xtab[i]) * 100.0 + 0.5))
                          / 100.0;
            }
            ...
            for (ndeg = 1; ndeg <= MAXDEG; ndeg++)
            {
                ...
                for (i = 1; i <= NTAB; i++)
                {
                    ...
                    for (j = 0; j <= jhi; j++)
                    {
                        ...
                        ytrue = (double)((int)(Math.Exp(xval) * 100.0 + 0.5))
                                / 100.0;
            ...
            //
        {
            ...
            {
                tdata[i] = (double)i;
                ydata[i] = Math.Sin(2.0 * pi * tdata[i] / (double)(NDATA - 1));
                Console.WriteLine(tdata[i].ToString().PadLeft(12) + "  "
                                                                  + ydata[i].ToString().PadLeft(12) + "");
            }
            ...
            //
        {
            ...
            for (k = 0; k <= 4; k++)
            {
                ...
                ypp = Burkardt.Spline.Cubic.spline_cubic_set(N, t, y, ibcbeg, ybcbeg, ibcend, ybcend);
                ...
                for (i = 0; i <= N; i++)
                {
                    ...
                    for (j = 1; j <= jhi; j++)
                    {
                        ...
                        yval = Burkardt.Spline.Cubic.spline_cubic_val(N, t, y, ypp, tval, ref ypval, ref yppval);
            ...
            for (k = 0; k < 3; k++)
            {
                ...
                for (i = 0; i <= N; i++)
                {
                    ...
                    for (j = 1; j <= jhi; j++)
                    {
                        ...
                        left_in = left;
                        Burkardt.Spline.Cubic.spline_cubic_val2(N, t, tval, ref left, y, ypp, ref yval, ref ypval,
                            ref yppval);
        ...
        static void parabola_formula(double x, ref double y, ref double yp, ref double ypp)
        ...
        static double fppcube(double x)
