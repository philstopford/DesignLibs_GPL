...
namespace SquareIntegralsTest
{
    class Program
    {
        ...
        static void square01_monomial_integral_test()
            ...
            //
        {
            ...
            for (test = 1; test <= test_num; test++)
            {
                ...
                result = Integrals.square01_area() * typeMethods.r8vec_sum(n, value) / (double) (n);
        ...
        static void squaresym_monomial_integral_test()
            ...
            //
        {
            ...
            for (test = 1; test <= test_num; test++)
            {
                ...
                result = Integrals.squaresym_area() * typeMethods.r8vec_sum(n, value) / (double) (n);
