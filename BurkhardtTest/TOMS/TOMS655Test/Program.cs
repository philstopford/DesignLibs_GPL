...
namespace TOMS655Test
{
    class Program
    {
            ...
            //
        {
            ...
            for (i = 1; i <= nt; i++)
            {
                t[i - 1] = Math.Cos((double) (2 * i - 1) * pi / (double) (2 * nt));
            }
            ...
            //
            wts = CIQFS.ciqfs(nt, t, mlt, nwts, ref ndx, key, kind, alpha, beta, lu);
        }
            ...
            //
        {
            ...
            //  This call returns the WTS array.
            //
            wts = CLIQFS.cliqfs(nt, t, kind, alpha, beta, lu);
        }
        ...
        static void test10(int nt, int kind, double alpha, double beta)
        ...
        static void cgqf_test(int nt, int kind, double alpha, double beta, double a, double b)
        ...
        static void wm_tester(int m, int kind, double alpha, double beta)
