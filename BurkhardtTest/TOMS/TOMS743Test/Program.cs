...
namespace TOMS743Test
{
    class Program
    {
            ...
            //
        {
            ...
            Bisect.BisectData bdata = new Bisect.BisectData();
            WAPRData wdata = new WAPRData();
        ...
        static void test02(int nbits, double dx, int n)
        ...
        static void test03(int nbits, double xmin, double xmax, int n)
