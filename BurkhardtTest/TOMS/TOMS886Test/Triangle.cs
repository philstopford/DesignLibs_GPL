...
namespace TOMS886Test
{
    public class TriangleTest
    {
        ...
        static double sigma1(double t1, double t2, double u1, double u2, double v1,
        ...
        static double isigm1(double sigma1, double sigma2, double u1, double u2, double v1,
                double v2, double w1, double w2)
        ...
        static double sigma2(double t1, double t2, double u1, double u2, double v1,
                double v2, double w1, double w2)
        ...
        static double isigm2(double sigma1, double sigma2, double u1, double u2, double v1,
                double v2, double w1, double w2)
        ...
        static void target(double u1, double u2, double v1, double v2, double w1, double w2,
