...
namespace TOMS917Test
{
    class Program
    {
        ...
        static void driver(Complex z)
            ...
            //
        {
            Complex condest = new Complex();
            Complex e = new Complex();
            Complex r = new Complex();
            Complex r_ult = new Complex();
            ...
            //
        {
            ...
            for (i = 0; i < n; i++)
            {
                z = new Complex(x[0] + td * (double) i, y[0]);
            ...
            for (i = 0; i < n; i++)
            {
                z = new Complex(x[0], (y[1] + td * (double) i));
                WrightOmega.wrightomega_ext(z, ref w, ref e, ref r, ref cond);
                fp.Add((z.Real) + " "
                                + (z.Imaginary) + " "
                                + (w.Real) + " "
            ...
            for (i = 0; i < n; i++)
            {
                z = new Complex(x[1] + td * (double) i, y[0]);
                WrightOmega.wrightomega_ext(z, ref w, ref e, ref r, ref cond);
                fp.Add((z.Real) + " "
                                + (z.Imaginary) + " "
                                + (w.Real) + " "
            ...
            for (i = 0; i < n; i++)
            {
                z = new Complex(x[0], (y[0] + td * (double) i));
                WrightOmega.wrightomega_ext(z, ref w, ref e, ref r, ref cond);
                fp.Add((z.Real) + " "
                                + (z.Imaginary) + " "
                                + (w.Real) + " "
            ...
            for (i = 0; i < n; i++)
            {
                a = NextAfterNS.NextAfter.nextafter(pi, -1.0) * Math.Cos(x[0] - td * (double) i)
                    + NextAfterNS.NextAfter.nextafter(1.0, -1.0);
                b = NextAfterNS.NextAfter.nextafter(pi, -1.0) * Math.Sin(x[0] - td * (double) i);
                z = new Complex(a, b);
                WrightOmega.wrightomega_ext(z, ref w, ref e, ref r, ref cond);
                fp.Add((z.Real) + " "
                                + (z.Imaginary) + " "
            ...
            for (i = 0; i < n; i++)
            {
                x[0] = NextAfterNS.NextAfter.nextafter(-1.0 - Math.Exp((double) (n - 1 - i) / exp_num),
                    typeMethods.r8_huge());
            ...
            */
            ...
            for (i = 0; i < n; i++)
            {
                ...
                if (y[1] < 0)
                {
                    z = new Complex(NextAfterNS.NextAfter.nextafter(x[0], typeMethods.r8_huge()),
            ...
            for (i = 0; i < n; i++)
            {
                x[0] = NextAfterNS.NextAfter.nextafter(-1.0 - Math.Exp((double) (i) / exp_num), typeMethods.r8_huge());
                y[0] = NextAfterNS.NextAfter.nextafter(-pi + 0.75 * (x[0] + 1.0), -typeMethods.r8_huge());
                z = new Complex(x[0], y[0]);
                WrightOmega.wrightomega_ext(z, ref w, ref e, ref r, ref cond);
                fp.Add((z.Real) + " "
            ...
            for (i = 0; i < n; i++)
            {
                x[0] = -1.0 - Math.Exp((double) (i) / exp_num);
                z = new Complex(x[0], y[0]);
                WrightOmega.wrightomega_ext(z, ref w, ref e, ref r, ref cond);
                fp.Add((z.Real) + " "
                                + (z.Imaginary) + " "
            ...
            for (i = 0; i < n; i++)
            {
                x[0] = -1.0 - Math.Exp((double) (n - 1 - i) / exp_num);
                z = new Complex(x[0], y[0]);
                WrightOmega.wrightomega_ext(z, ref w, ref e, ref r, ref cond);
                fp.Add((z.Real) + " "
                                + (z.Imaginary) + " "
