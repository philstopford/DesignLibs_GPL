...
{
    using QuadratureRule = Burkardt.TetrahedronNS.QuadratureRule;
    ...
    class Program
    {
            ...
            //
        {
            ...
            r = typeMethods.r8mat_data_read(quad_r_filename, dim_num, 4);
            //
            //  Rescale the weights.
            //
            volume = Tetrahedron.tetrahedron_volume(r);
            ...
            //
            x_ref = new double[dim_num * point_num];
