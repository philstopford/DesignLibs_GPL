...
namespace TriangleDunavantRuleTest;
...
internal static class Program
{
    private static void Main()
        ...
        //
    {
        Console.WriteLine("TRIANGLE_DUNAVANT_RULE_TEST:");
        Console.WriteLine("  Test the TRIANGLE_DUNAVANT_RULE library.");
        ...
        //
    {
        ...
        Console.WriteLine("  DUNAVANT_RULE_NUM returns the number of rules;");
        Console.WriteLine("  DUNAVANT_DEGREE returns the degree of a rule;");
        Console.WriteLine("  DUNAVANT_ORDER_NUM returns the order of a rule.");

        int rule_num = DunavantRule.dunavant_rule_num();
        ...
        {
            int order_num = DunavantRule.dunavant_order_num(rule);
            int degree = DunavantRule.dunavant_degree(rule);
        ...
        //
    {
        ...
        Console.WriteLine("  DUNAVANT_RULE returns the points and weights");
        Console.WriteLine("  of a Dunavant rule for the triangle.");
        Console.WriteLine("");
        ...
        for (rule = 1; rule <= rule_num; rule++)
        {
            ...
            DunavantRule.dunavant_rule(rule, order_num, ref xytab, ref wtab);
        ...
        //
    {
        ...
        for (rule = 1; rule <= rule_num; rule++)
        {
            int suborder_num = DunavantRule.dunavant_suborder_num(rule);

            double[] suborder_xyz = new double[3 * suborder_num];
            double[] suborder_w = new double[suborder_num];

            DunavantRule.dunavant_subrule(rule, suborder_num, ref suborder_xyz, ref suborder_w);
        ...
        //
    {
        ...
        const int rule_max = 10;
        double value = 0;

        Console.WriteLine("");
        Console.WriteLine("TEST04");
        Console.WriteLine("  DUNAVANT_RULE returns the points and weights of");
        Console.WriteLine("  a Dunavant rule for the unit triangle.");
        Console.WriteLine("");
        ...
        //
    {
        ...
        DunavantRule.dunavant_rule(rule, order_num, ref xy, ref w);
        //
