...
internal static class Program
{
        ...
        //
    {
        ...
        rule_num = DunavantRule.dunavant_rule_num();
        ...
        {
            order_num = DunavantRule.dunavant_order_num(rule);
            degree = DunavantRule.dunavant_degree(rule);
        ...
        //
    {
        ...
        for (rule = 1; rule <= rule_num; rule++)
        {
            suborder_num = DunavantRule.dunavant_suborder_num(rule);
