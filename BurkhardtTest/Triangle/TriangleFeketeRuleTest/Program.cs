...
namespace TriangleFeketeRuleTest
{
    ...
    class Program
    {
        ...
        {
            Console.WriteLine("");
            Console.WriteLine("TRIANGLE_FEKETE_RULE_TEST:");
            Console.WriteLine("  Test the TRIANGLE_FEKETE_RULE library.");
            ...
            //
        {
            ...
            rule_num = FeketeRule.fekete_rule_num();
            ...
            //
        {
            ...
            for (rule = 1; rule <= rule_num; rule++)
            {
                suborder_num = FeketeRule.fekete_suborder_num(rule);
