...
internal static class Program
{
        ...
        //
    {
        ...
        //
        int seed = 123456789;
        double[] p = Burkardt.Uniform.Triangle.uniform_in_triangle_map1(p1, p2, p3, n, ref seed);
        //
        //  Request an intepolated value for R, G and B at each point.
        //
        double[] v = Interpolate.triangle_interpolate_linear(m, n, p1, p2, p3, p, v1, v2, v3);
        //
        //  Report the data.
        //
        Console.WriteLine("");
