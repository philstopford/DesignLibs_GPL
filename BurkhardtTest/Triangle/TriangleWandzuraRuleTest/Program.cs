...
namespace TriangleWandzuraRuleTest
{
    class Program
    {
        ...
        {
            Console.WriteLine("");
            Console.WriteLine("TRIANGLE_WANDZURA_RULE_TEST:");
            Console.WriteLine("  Test the TRIANGLE_WANDZURA_RULE library.");
            ...
            //
        {
            ...
            rule_num = WandzuraRule.wandzura_rule_num();
            ...
            {
                order_num = WandzuraRule.wandzura_order_num(rule);
                degree = WandzuraRule.wandzura_degree(rule);
            ...
            //
        {
            ...
            for (rule = 1; rule <= rule_num; rule++)
            {
                suborder_num = WandzuraRule.wandzura_suborder_num(rule);

                suborder_xyz = new double[3 * suborder_num];
                suborder_w = new double[suborder_num];

                WandzuraRule.wandzura_subrule(rule, suborder_num, ref suborder_xyz, ref suborder_w);
            ...
            //
        {
            ...
            area2 = area = Integrals.triangle_area(node_xy2);
