...
namespace ZigguratTest
{
    class Program
    {
        ...
        static void shr3_seeded_test2(int sample_num)
        ...
        static void test06(int sample_num)
        ...
        static void test07(int sample_num)
        ...
        static void test08(int sample_num)
