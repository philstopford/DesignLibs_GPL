...
public static class AlpertRule
{
       ...
       public static double integral_log()
              ...
              //
       {
              const double value = -0.012771107587415899716E+00;
       ...
       public static double integral_power()
              ...
              //
       {
              const double value = 0.079321002746971411182E+00;
       ...
       public static double integral_regular()
              ...
              //
       {
              double value = (-Math.Sin(0.3E+00) + Math.Sin(200.0E+00)
