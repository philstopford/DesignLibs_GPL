    ...
    public static partial class CDF
    {
            ...
            //
        {
            ...
            else if (4 == which)
            {
                ...
                T14 = atol;
                T15 = tol;
                eData.dstinv(T12, T13, K4, K4, K5, T14, T15);
            ...
            //
        {
            ...
            else if (4 == which)
            {
                ...
                T13 = atol;
                T14 = tol;
                eData.dstinv(T11, T12, K3, K3, K4, T13, T14);
                eData.status = 0;
                eData.dinvr();
                S260:
            ...
            else if (5 == which)
            {
                ...
                T16 = atol;
                T17 = tol;
                eData.dstinv(K1, T15, K3, K3, K4, T16, T17);
                eData.status = 0;
                eData.dinvr();
                S310:
