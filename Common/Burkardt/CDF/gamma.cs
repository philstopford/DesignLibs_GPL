...
namespace Burkardt.CDFLib
{
    public static partial class CDF
    {
        ...
        public static void gamma_inc_inv(double a, ref double x, double x0, double p, double q,
                ref int ierr)
        ...
        public static void gamma_inc_values(ref int n_data, double a, ref double x, ref double fx)
        ...
        public static void gamma_rat1(double a, double x, double r, ref double p, ref double q,
            ...
            //
            //    Input, double *R, the valueMath.Exp(-X) * X**A / Gamma(A).
            //
        ...
        public static void gamma_values(int n_data, ref double x, ref double fx)
        ...
        public static double gamma_x(double a)
            ...
            //  Discussion:
            //
            //    This routine was renamed from "GAMMA" to apublic static void a conflict with the
