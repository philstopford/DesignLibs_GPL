...
namespace Burkardt.ChebyshevPolynomialNS
{
    public static partial class ChebyshevPolynomial
    {
            ...
            //
        {
            ...
            {
                value = typeMethods.r8_choose(e, e / 2) * Math.PI / Math.Pow(2.0, e);
            }
        ...
        //
        {
            ...
            for (k = 0; k <= n; k++)
            {
                t = Math.Cos(Math.PI * ((double) (k) + 0.5) / (double) (n + 1));
        ...
        public static void t_quadrature_rule(int n, double[] t, double[] w )
            ...
            //
        {
            ...
            else
            {
                value = 0.5 * (
                    ...
                    +tt_product_integral(Math.Abs(i - j), k));
            }
