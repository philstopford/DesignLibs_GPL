...
namespace Burkardt.ChebyshevPolynomialNS
{
    public static partial class ChebyshevPolynomial
    {
            ...
            //
        {
            ...
            f4 = 2.0 * typeMethods.r8_mop(e) * typeMethods.r8_hyper_2f1(0.5, -r8_e, 1.0, 2.0);
            ...
            f8 = 2.0 * typeMethods.r8_mop(e) * typeMethods.r8_hyper_2f1(0.5, 1.0 + r8_e, 1.5 + r8_e, -1.0);
            ...
            //
        {
            ...
            for (int i = 0; i < n; i++)
            {
                double angle = (double) (2 * (n - i)) * Math.PI / (double) (2 * n + 1);
                z[i] = Math.Cos(angle);
            }
