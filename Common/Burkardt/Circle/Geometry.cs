...
namespace Burkardt.CircleNS
{
    public static class Geometry
    {
            ...
            //
        {
            ...
            else if (typeMethods.r8vec_eq(DIM_NUM, p1, p3))
            {
            ...
            else if (typeMethods.r8vec_eq(DIM_NUM, p2, p3))
            {
                r = 0.5 * Math.Sqrt((p1[0] - p2[0]) * (p1[0] - p2[0])
                                    + (p1[1] - p2[1]) * (p1[1] - p2[1]));
                pc[0] = 0.5 * (p1[0] + p2[0]);
            ...
            //
        {
            ...
            if (typeMethods.r8vec_eq(DIM_NUM, p, pc))
            {
                ...
                for (i = 0; i < DIM_NUM; i++)
                {
                    pn[i] = pc[i] + r / Math.Sqrt((double) (DIM_NUM));
                }
            ...
            //
        {
            ...
            for (j = 0; j < n; j++)
            {
                angle = (2.0 * Math.PI * (double) j) / (double) n;
            ...
            //
        {
            ...
            for (j = 0; j < n; j++)
            {
                theta = (2.0 * Math.PI * (double) (j)) / (double) (n);
            ...
            //
        {
            ...
            {
                d = 4.0 * r * Math.Pow((Math.Sin(0.5 * theta)), 3) /
            ...
            //
        {
            ...
            {
                d = 4.0 * r * Math.Sin(0.5 * theta) / (3.0 * theta);
            }
