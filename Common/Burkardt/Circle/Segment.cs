...
namespace Burkardt.CircleNS
{
    public static class Segment
    {
        ...
        //
        {
            ...
            //
            area = Math.PI * r * r * (double) (m) / (double) (n);
        ...
        //
        {
            ...
            d[0] = typeMethods.r8vec_sum(n, x) / (double) (n);
            d[1] = typeMethods.r8vec_sum(n, y) / (double) (n);
            ...
            //
        {
            ...
            if (angle <= Math.PI)
            {
                h = r * (1.0 - Math.Cos(angle / 2.0));
            }
            else
            {
                h = r * (1.0 + Math.Cos((2.0 * Math.PI - angle) / 2.0));
            }
