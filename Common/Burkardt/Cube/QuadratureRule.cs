...
public static class QuadratureRule
{
        ...
        //
    {
        ...
        switch (degree)
        {
            ...
            default:
                Console.WriteLine("");
                Console.WriteLine("CUBE_ARBQ - Fatal error");
        ...
        //
    {
        ...
        switch (degree)
        {
            ...
            case > 15:
                Console.WriteLine("");
                Console.WriteLine("CUBE_ARBQ_SIZE - Fatal error!");
                Console.WriteLine("  Illegal value of DEGREE.");
                return 1;
            default:
                n = n_save[degree - 1];
        ...
        //
    {
        ...
        typeMethods.r8mat_row_copy(3, n, 0, xs, ref x);
        typeMethods.r8mat_row_copy(3, n, 1, ys, ref x);
        ...
        //
    {
        ...
        for (i = 0; i < 3; i++)
        {
            ...
            typeMethods.r8vec_direct_product2(ref data2, i, o, w_1d, 3, order, ref w);

        }
    }

    private static void line_unit_o01(double[] w, double[] x)
    ...
    private static void line_unit_o02(double[] w, double[] x)
    ...
    private static void line_unit_o03(double[] w, double[] x)
    ...
    private static void line_unit_o04(double[] w, double[] x)
    ...
    private static void line_unit_o05(double[] w, double[] x)
