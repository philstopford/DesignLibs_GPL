...
public static class FM_inc
{
        ...
        //
    {
        ...
        {
            Console.WriteLine("");
            Console.WriteLine("ELLIPTIC_INC_FM - Fatal error!");
    ...
    public static void values(ref int n_data, ref double phi, ref double m, ref double fm )
