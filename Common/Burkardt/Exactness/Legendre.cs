...
namespace Burkardt.ExactnessNS
{
    public static partial class Exactness
    {
            ...
            //
        {
            ...
            value = (Math.Pow(b[0], p[0] + 1) - Math.Pow(a[0], p[0] + 1)) / (double) (p[0] + 1)
                * (Math.Pow(b[1], p[1] + 1) - Math.Pow(a[1], p[1] + 1)) / (double) (p[1] + 1)
                * (Math.Pow(b[2], p[2] + 1) - Math.Pow(a[2], p[2] + 1)) / (double) (p[2] + 1);
