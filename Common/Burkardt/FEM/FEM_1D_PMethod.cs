...
//
            ...
            {
                double xl = (double) (2 * i - nsub - 1) / (double) (nsub);
                double xr = (double) (2 * i - nsub) / (double) (nsub);
                ...
                for (int j = 0; j < quad_num; j++)
                {
                    ...
                    big_l2 = big_l2 + Math.Pow(up - uex(x, problem), 2) * quad_w[j]
                                                                   * (xr - xl) / 2.0;
                }
            }
...
//
        {
            ...
            {
                double x = (double) (2 * ip - nprint) / (double) (nprint);
                double up = 0.0;
                for (int i = 0; i <= np; i++)
                {
                    phi(alpha, beta, i, np, ref phii, ref phiix, x);
