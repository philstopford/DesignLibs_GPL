    ...
    public static partial class Slow
    {
            ...
            //
        {
            ...
            for (i = 0; i < n; i++)
            {
                ...
                for (j = 1; j < n - 1; j++)
                {
                    angle = (float) Math.PI * (float) ((i * j) % (2 * (n - 1)))
                            / (float) (n - 1);
            ...
            for (i = 0; i < n; i++)
            {
                y[i] = (float) (2.0 * y[i] * Math.Sqrt((float) (n) / (float) (n - 1)));
            }
            ...
            //
        {
            ...
            for (i = 0; i < (n / 2); i++)
            {
                ...
                for (j = 0; j < n; j++)
                {
                    ...
                    a[i] = a[i] + r[j] * (float) Math.Cos(theta);
                    b[i] = b[i] + r[j] * (float) Math.Sin(theta);
                }
            ...
            //
        {
            ...
            for (j = 0; j < n; j++)
            {
                for (i = 0; i < n; i++)
                {
                    y[i] = (float) (y[i] + 2.0 * x[j] * Math.Sin((float) (j + 1) * theta[i]));
                }
            }
