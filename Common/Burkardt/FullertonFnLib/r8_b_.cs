...
namespace Burkardt.FullertonFnLib
{
    public static partial class FullertonLib
    {
            ...
            //
        {
            ...
            xnu = nu - (int) (nu);
            nin = (int) (nu) + 1;
            r8_besks(ref data.gdata, ref data.kdata, ref data, xnu, x, nin, ref bke);
        ...
        static void r8_beskes(ref r8GammaData gdata, ref r8KnusData kdata, ref BesselData data, double xnu, double x, int nin, ref double[] bke)
            ...
            //
        {
            ...
            r8_knus(ref gdata, ref kdata, v, x, ref bke[0], ref data.bknu1, ref data.iswtch);
            ...
            if (direct < 0.0)
            {
                r8_knus(ref gdata, ref kdata, Math.Abs(xnu + vincr), x, ref bke[1], ref data.bknu1, ref data.iswtch);
            }
        ...
        static void r8_besks(ref r8GammaData gdata, ref r8KnusData kdata, ref BesselData data, double xnu, double x, int nin, ref double[] bk)
            ...
            //
        {
            ...
            r8_beskes(ref gdata, ref kdata, ref data, xnu, x, nin, ref bk);
        ...
        public static double r8_beta(ref r8GammaData gdata, ref BesselData data, double a, double b)
        ...
        public static double r8_bi(double x)
            ...
            //
        {
            ...
            {
                value = r8_bie(x) * Math.Exp(2.0 * x * Math.Sqrt(x) / 3.0);
            }

            return value;
        }

        public static double r8_bid(double x)
            ...
            //
        {
            ...
            {
                value = r8_bide(x) * Math.Exp(2.0 * x * Math.Sqrt(x) / 3.0);
            }

            return value;
        }

        public static double r8_bide(double x)
            ...
            //
        {
            ...
            else if (x <= 4.0)
            {
                sqrtx = Math.Sqrt(x);
                z = atr / x / sqrtx + btr;
                value = (0.625 + r8_csevl(z, bip1cs, nbip1)) * Math.Sqrt(sqrtx);
            }
            else if (x <= xbig)
            {
                sqrtx = Math.Sqrt(x);
                z = 16.0 / x / sqrtx - 1.0;
                value = (0.625 + r8_csevl(z, bip2cs, nbip2)) * Math.Sqrt(sqrtx);
            }
            else
            {
                sqrtx = Math.Sqrt(x);
        ...
        public static double r8_bie(double x)
        ...
        public static double r8_binom(int n, int m)
            ...
            //
        {
            ...
            if (bilnmx == 0.0)
            {
                bilnmx = Math.Log(r8_mach(2)) - 0.0001;
            ...
            if (k <= 20 &&
                (double) (k) * Math.Log((double) (i4_max(n, 1))) <= bilnmx)
            {
                value = 1.0;
                for (i = 1; i <= k; i++)
                {
