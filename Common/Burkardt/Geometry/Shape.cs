...
namespace Burkardt.Geometry
{
    public static class Shape
    {
            ...
            //
        {
            ...
            //
            if (Math.Sqrt(Math.Pow(p[0] - pc[0], 2) + Math.Pow(p[1] - pc[1], 2)) == 0.0)
            {
                dist = radius * Math.Cos(Math.PI / (double) side_num);
                return dist;
            }
            ...
            Burkardt.Vector.Geometry.vector_rotate_base_2d(p1, pc, angle2, ref pa);

            angle2 = ((double) sector_index) * sector_angle;
            angle2 = Helpers.degrees_to_radians(angle2);

            Burkardt.Vector.Geometry.vector_rotate_base_2d(p1, pc, angle2, ref pb);
            //
            ...
            //
        {
            ...
            for (sector_index = 1; sector_index <= side_num; sector_index++)
            {
                ...
                if (sector_index == 1)
                {
                    ...
                    Burkardt.Vector.Geometry.vector_rotate_base_2d(p1, pc, angle2, ref pv1);
                }
                else
                {
                ...
                Burkardt.Vector.Geometry.vector_rotate_base_2d(p1, pc, angle2, ref pv2);
                //
                ...
                if (inside)
                {
                    ...
                    //  as full lines).
                    //
                    Burkardt.LineNS.Geometry.lines_exp_int_2d(pa, pb, pv1, pv2, ref ival, ref pint);
