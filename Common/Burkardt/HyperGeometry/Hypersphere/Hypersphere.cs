        ...
        //
        {
            ...
            for (i = 1; i < m - 1; i++)
            {
                for (i1 = 0; i1 <= i - 1; i1++)
                {
                    for (j = 0; j < n; j++)
                    {
                        theta[i1 + j * (m - 1)] = theta[i1 + j * (m - 1)] + Math.Pow(x2[i + j * m], 2);
                    }
                }
            }
            ...
            for (j = 0; j < n; j++)
            {
                for (i = 0; i < m - 2; i++)
                {
                    theta[i + j * (m - 1)] = theta[i + j * (m - 1)] + Math.Pow(x2[m - 1 + j * m], 2);
                }
            }
        ...
        //
        {
            ...
            else
            {
                ...
                for (j = 0; j < n; j++)
                {
                    for (i1 = 0; i1 < m - 1; i1++)
                    {
                        x[i1 + j * m] = x[i1 + j * m] * Math.Cos(theta[i1 + j * (m - 1)]);
                        for (i2 = i1 + 1; i2 < m; i2++)
                        {
                            x[i2 + j * m] = x[i2 + j * m] * Math.Sin(theta[i1 + j * (m - 1)]);
                        }
                    }
                }
