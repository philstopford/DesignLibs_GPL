    ...
    public static class KMeans
    {
            ...
            //
        {
            ...
            for (j = 0; j < point_num; j++)
            {
                ...
                for (i = 0; i < dim_num; i++)
                {
                    f[j] = f[j] + Math.Pow(point[i + j * dim_num] - cluster_center[i + k * dim_num], 2);
                }
            }
                ...
                for (j = 0; j < point_num; j++)
                {
                    ...
                    for (k = 0; k < cluster_num; k++)
                    {
                        if (k != il)
                        {
                            ...
                            for (i = 0; i < dim_num; i++)
                            {
                                de = de + Math.Pow(point[i + j * dim_num] - cluster_center[i + k * dim_num], 2);
                            }
                    ...
                    for (j2 = 0; j2 < point_num; j2++)
                    {
                        ...
                        if (k == il || k == ir)
                        {
                            ...
                            for (i = 0; i < dim_num; i++)
                            {
                                f[j2] = f[j2] + Math.Pow(point[i + j2 * dim_num] - cluster_center[i + k * dim_num], 2);
                            }
            ...
            //
        {
            ...
            for (j = 0; j < point_num; j++)
            {
                ...
                for (il = 0; il < 2; il++)
                {
                    ...
                    for (i = 0; i < dim_num; i++)
                    {
                        dt[il] = dt[il] + Math.Pow(point[i + j * dim_num] - cluster_center[i + il * dim_num], 2);
                    }
                }
                ...
                for (k = 2; k < cluster_num; k++)
                {
                    ...
                    for (i = 0; i < dim_num; i++)
                    {
                        db = db + Math.Pow(point[i + j * dim_num] - cluster_center[i + k * dim_num], 2);
                    }
            ...
            for (j = 0; j < point_num; j++)
            {
                ...
                if (1 < cluster_population[l1])
                {
                    ...
                    if (ncp[l1] != 0)
                    {
                        ...
                        for (i = 0; i < dim_num; i++)
                        {
                            d[j] = d[j] + Math.Pow(point[i + j * dim_num] - cluster_center[i + l1 * dim_num], 2);
                        }
                    ...
                    for (i = 0; i < dim_num; i++)
                    {
                        r2 = r2 + Math.Pow(point[i + j * dim_num] - cluster_center[i + l2 * dim_num], 2);
                    }
                    ...
                    for (l = 0; l < cluster_num; l++)
                    {
                        ...
                        if ((j < live[l1] || j < live[l]) && l != l1 && l != ll)
                        {
                            ...
                            for (i = 0; i < dim_num; i++)
                            {
                                dc = dc + Math.Pow(point[i + j * dim_num] - cluster_center[i + l * dim_num], 2);
                            }
                ...
                for (j = 0; j < point_num; j++)
                {
                    ...
                    if (1 < cluster_population[l1])
                    {
                        ...
                        if (step < ncp[l1] || step < ncp[l2])
                        {
                            ...
                            for (i = 0; i < dim_num; i++)
                            {
                                dd = dd + Math.Pow(point[i + j * dim_num] - cluster_center[i + l2 * dim_num], 2);
                            }
                ...
                for (j = 0; j < point_num; j++)
                {
                    ...
                    for (cj = 0; cj < cluster_num; cj++)
                    {
                        if (cj == ci)
                        {
                            ...
                            {
                                distsq[cj] = distsq[cj]
                                             + Math.Pow(point[i + j * dim_num] - cluster_center[i + cj * dim_num], 2);
                            }
