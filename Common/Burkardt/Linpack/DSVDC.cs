    ...
    public static class DSVDC
    {
            ...
            //
        {
            ...
            for (l = 1; l <= lu; l++)
            {
                ...
                if (l <= nct)
                {
                    s[l - 1] = BLAS1D.dnrm2(m - l + 1, a, 1, index: +l - 1 + (l - 1) * lda);
                    ...
                    if (s[l - 1] != 0.0)
                    {
                        ...
                        BLAS1D.dscal(m - l + 1, 1.0 / s[l - 1], ref a, 1, index: +l - 1 + (l - 1) * lda);
                ...
                for (j = l + 1; j <= n; j++)
                {
                    ...
                    if (l <= nct && s[l - 1] != 0.0)
                    {
                        t = -BLAS1D.ddot(m - l + 1, a, 1, a, 1, xIndex: +l - 1 + (l - 1) * lda,
                                yIndex: +l - 1 + (j - 1) * lda)
                            / a[l - 1 + (l - 1) * lda];
                        BLAS1D.daxpy(m - l + 1, t, a, 1, ref a, 1, xIndex: +l - 1 + (l - 1) * lda,
                            yIndex: +l - 1 + (j - 1) * lda);
                    }
                ...
                if (l <= nrt)
                {
                    ...
                    //
                    e[l - 1] = BLAS1D.dnrm2(n - l, e, 1, index: +l);
                    ...
                    if (e[l - 1] != 0.0)
                    {
                        ...
                        BLAS1D.dscal(n - l, 1.0 / e[l - 1], ref e, 1, index: +l);
                        e[l] = 1.0 + e[l];
                    }
                    ...
                    if (l + 1 <= m && e[l - 1] != 0.0)
                    {
                        ...
                        for (j = l + 1; j <= n; j++)
                        {
                            BLAS1D.daxpy(m - l, e[j - 1], a, 1, ref work, 1, xIndex: +l + (j - 1) * lda, yIndex: +l);
                        }

                        for (j = l + 1; j <= n; j++)
                        {
                            BLAS1D.daxpy(m - l, -e[j - 1] / e[l], work, 1, ref a, 1, xIndex: +l,
                                yIndex: +l + (j - 1) * lda);
                        }
                    }
            ...
            if (wantu)
            {
                ...
                for (ll = 1; ll <= nct; ll++)
                {
                    ...
                    if (s[l - 1] != 0.0)
                    {
                        for (j = l + 1; j <= ncu; j++)
                        {
                            t = -BLAS1D.ddot(m - l + 1, u, 1, u, 1, xIndex: +(l - 1) + (l - 1) * ldu,
                                    yIndex: +(l - 1) + (j - 1) * ldu)
                                / u[l - 1 + (l - 1) * ldu];
                            BLAS1D.daxpy(m - l + 1, t, u, 1, ref u, 1, xIndex: +(l - 1) + (l - 1) * ldu,
                                yIndex: +(l - 1) + (j - 1) * ldu);
                        }

                        BLAS1D.dscal(m - l + 1, -1.0, ref u, 1, index: +(l - 1) + (l - 1) * ldu);
            ...
            if (wantv)
            {
                for (ll = 1; ll <= n; ll++)
                {
                    ...
                    if (l <= nrt && e[l - 1] != 0.0)
                    {
                        for (j = l + 1; j <= n; j++)
                        {
                            t = -BLAS1D.ddot(n - l, v, 1, v, 1, xIndex: +l + (l - 1) * ldv, yIndex: +l + (j - 1) * ldv)
                                / v[l + (l - 1) * ldv];
                            BLAS1D.daxpy(n - l, t, v, 1, ref v, 1, xIndex: +l + (l - 1) * ldv,
                                yIndex: +l + (j - 1) * ldv);
                        }
            ...
            while (0 < mn)
            {
                ...
                if (kase == 1)
                {
                    ...
                    for (kk = 1; kk <= mm1; kk++)
                    {
                        ...
                        if (wantv)
                        {
                            BLAS1D.drot(n, ref v, 1, ref v, 1, cs, sn, xindex: +0 + (k - 1) * ldv,
                                yindex: +0 + (mn - 1) * ldv);
                        }
                    }
                }
                ...
                else if (kase == 2)
                {
                    ...
                    for (k = l; k <= mn; k++)
                    {
                        ...
                        if (wantu)
                        {
                            BLAS1D.drot(m, ref u, 1, ref u, 1, cs, sn, xindex: +0 + (k - 1) * ldu,
                                yindex: +0 + (l - 2) * ldu);
                        }
                    }
                }
                ...
                else if (kase == 4)
                {
                    ...
                    if (s[l - 1] < 0.0)
                    {
                        ...
                        if (wantv)
                        {
                            BLAS1D.dscal(n, -1.0, ref v, 1, index: +0 + (l - 1) * ldv);
                        }
                    }
                    ...
                    for (;;)
                    {
                        ...
                        if (wantv && l < n)
                        {
                            BLAS1D.dswap(n, ref v, 1, ref v, 1, xIndex: +0 + (l - 1) * ldv, yIndex: +0 + l * ldv);
                        }

                        if (wantu && l < m)
                        {
                            BLAS1D.dswap(m, ref u, 1, ref u, 1, xIndex: +0 + (l - 1) * ldu, yIndex: +0 + l * ldu);
                        }
