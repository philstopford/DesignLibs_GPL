            ...
            //
        {
            ...
            while (0 < k)
            {
                ...
                else
                {
                    ...
                    bk = z[k - 1] / Complex.Conjugate(ap[km1k - 1]);
            ...
            while (k <= n)
            {
                ...
                if (k != 1)
                {
                    z[k - 1] = z[k - 1] + BLAS1Z.zdotc(k - 1, ap, 1, z, 1, xIndex: +ik);
                    ikp1 = ik + k;

                    if (ks == 2)
                    {
                        z[k] = z[k] + BLAS1Z.zdotc(k - 1, ap, 1, z, 1, xIndex: +ikp1);
                    }
