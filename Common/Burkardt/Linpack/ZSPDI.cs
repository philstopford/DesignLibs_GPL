                ...
                while (k <= n)
                {
                    ...
                    if (0 <= ipvt[k - 1])
                    {
                        ...
                        if (1 <= km1)
                        {
                            ...
                            ap[kk - 1] = ap[kk - 1] + BLAS1Z.zdotu(km1, work, 1, ap, 1, yIndex: +ik);
                        }
                    ...
                    else
                    {
                        ...
                        if (1 <= km1)
                        {
                            ...
                            ap[kkp1] = ap[kkp1] + BLAS1Z.zdotu(km1, work, 1, ap, 1, yIndex: +ikp1);
                            ap[kkp1 - 1] = ap[kkp1 - 1] + BLAS1Z.zdotu(km1, ap, 1, ap, 1, xIndex: +ik, yIndex: +ikp1);
