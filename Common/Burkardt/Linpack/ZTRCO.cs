    ...
    public static class ZTRCO
    {
            ...
            //
        {
            ...
            for (kk = 1; kk <= n; kk++)
            {
                ...
                {
                    wk = wk / Complex.Conjugate(t[k - 1 + (k - 1) * ldt]);
                    wkm = wkm / Complex.Conjugate(t[k - 1 + (k - 1) * ldt]);
                }
                else
                {
                ...
                if (kk != n)
                {
                    ...
                    for (j = j1; j <= j2; j++)
                    {
                        sm = sm + typeMethods.zabs1(z[j - 1] + wkm * Complex.Conjugate(t[k - 1 + (j - 1) * ldt]));
                        z[j - 1] = z[j - 1] + wk * Complex.Conjugate(t[k - 1 + (j - 1) * ldt]);
                    ...
                    if (s < sm)
                    {
                        ...
                        for (j = j1; j <= j2; j++)
                        {
                            z[j - 1] = z[j - 1] + w * Complex.Conjugate(t[k - 1 + (j - 1) * ldt]);
                        }
                    }
                }
