...
typeMethods.c8mat_add_r8 ( n, n, one, e, c, a2, e );

d = typeMethods.c8mat_identity_new ( n );

typeMethods.c8mat_add_r8 ( n, n, one, d, -c, a2, d );
...
typeMethods.c8mat_mm ( n, n, n, a2, x, x );

typeMethods.c8mat_add_r8 ( n, n, c, x, one, e, e );

if ( p )
{
    typeMethods.c8mat_add_r8 ( n, n, c, x, one, d, d );
}
else
{
    typeMethods.c8mat_add_r8 ( n, n, -c, x, one, d, d );
...
for ( k = 1; k <= s; k++ )
{
    typeMethods.c8mat_mm ( n, n, n, e, e, e );
}
