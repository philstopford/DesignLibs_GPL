...
namespace Burkardt.NiederreiterNS
{
    public static partial class Niederreiter
    {
        ...
        //
        static int DEG_MAX = 50;
        static int P;
        static int Q;
        static int Q_MAX = 50;

        static int[,] add = new int[Q_MAX, Q_MAX];
        static int[,] mul = new int[Q_MAX, Q_MAX];

        static int[,] sub = new int[Q_MAX, Q_MAX];
        ...
        //
        static int DIM_MAX = 50;

        //const int FIG_MAX = 20;
        static int FIG_MAX = 31;

        static int[,,] C = new int [DIM_MAX, FIG_MAX, FIG_MAX];
        static int[] COUNT = new int[FIG_MAX];
        static int[,] D = new int[DIM_MAX, FIG_MAX];
        static int DIMEN;
        static int[] NEXTQ = new int[DIM_MAX];
        static int NFIGS;
        static int[] QPOW = new int[FIG_MAX];
        static double RECIP;
            ...
            //
        {
            ...
            //
            temp = Math.Log(Math.Pow(2.0, nbits) - 1.0) / Math.Log((double) (Q));
            ...
            //  Set RECIP.
            //
            RECIP = 1.0 / (double) (Math.Pow(Q, NFIGS));
            //
            ...
            //
        {
            ...
            output.Add("#  created by NIEDERREITER.C.");
            output.Add("#");
