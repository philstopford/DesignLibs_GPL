...
public static class Approx1D
{
    ...
    public static double[] pwl_approx_1d_matrix(int nd, double[] xd, double[] yd, int nc,
            double[] xc)
    ...
    public static double[] pwl_interp_1d(int nd, double[] xd, double[] yd, int ni, double[] xi)
