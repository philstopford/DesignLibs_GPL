...
public static class Geometry
{
        ...
        //
    {
        ...
        Vector.Geometry.vector_unit_nd(DIM_NUM, ref v1);
        ...
        Vector.Geometry.vector_unit_nd(DIM_NUM, ref v2);
        switch (ncor3)
        {
            //
        ...
        //
    {
        ...
        Vector.Geometry.vector_unit_nd(3, ref v1);
        ...
        Vector.Geometry.vector_unit_nd(3, ref v2);
        //
        ...
        //
    {
        ...
        {
            < 0.0 => -dist,
            _ => -(a * p[0] + b * p[1] + c * p[2] + d) / Math.Sqrt(a * a + b * b + c * c)
        };
