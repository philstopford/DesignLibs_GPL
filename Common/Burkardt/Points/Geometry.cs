...
# undef DIM_NUM
            ...
            //
        {
            ...
            if (x_scale < y_scale)
            {
                delta = (int) typeMethods.r8_nint((double) (x_ps_max - x_ps_min)
            ...
            {
                delta = (int) typeMethods.r8_nint((double) (y_ps_max - y_ps_min)
            ...
            //
        {
            ...
            for (j = 0; j < nset; j++)
            {
                ...
                for (i = 0; i < DIM_NUM; i++)
                {
                    d = d + Math.Pow(ptest[i] - pset[i + j * DIM_NUM], 2);
                }
            ...
            //
        {
            ...
            for (test = 0; test < ntest; test++)
            {
                ...
                for (set = 0; set < nset; set++)
                {
                    ...
                    for (i = 0; i < DIM_NUM; i++)
                    {
                        d = d + Math.Pow(ptest[i + test * DIM_NUM] - pset[i + set * DIM_NUM], 2);
                    }
