...
namespace Burkardt
{
    public static class PattersonQuadrature
    {
        public static void patterson_set(int n, double[] x, double[] w)
            ...
            //
        {
            ...
            {
                Console.WriteLine("");
                Console.WriteLine("PATTERSON_SET - Fatal error!");
                Console.WriteLine("  Illegal input value of N.");
                Console.WriteLine("  N must be 1, 3, 7, 15, 31, 63, 127, 255, or 511.");
            }
        }
    }
}