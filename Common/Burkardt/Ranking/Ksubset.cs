...
namespace Burkardt.RankingNS
{
    public static partial class Ranking
    {
            ...
            // 
        {
            ...
            for (i = 0; i < k; i++)
            {
                rank = rank + typeMethods.i4_choose(t[i] - 1, k - i);
            }
            ...
            // 
        {
            ...
            for (i = 1; i <= k; i++)
            {
                ...
                t[i - 1] = x + 1;
                rank_copy = rank_copy - typeMethods.i4_choose(x, k + 1 - i);
            }
            ...
            // 
        {
            ...
            for (i = 1; i <= k; i++)
            {
                ...
                if (tim1 + 1 <= t[i - 1] - 1)
                {
                    ...
                    {
                        rank = rank + typeMethods.i4_choose(n - j, k - i);
                    }
                }
            }
            ...
            // 
        {
            ...
            for (i = 1; i <= k; i++)
            {
                ...
                {
                    rank_copy = rank_copy - typeMethods.i4_choose(n - x, k - i);
                    x = x + 1;
                }
            ...
            // 
        {
            ...
            for (i = k; 1 <= i; i--)
            {
                rank = rank + s * typeMethods.i4_choose(t[i - 1], i);
                s = -s;
            }
