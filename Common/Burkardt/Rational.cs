...
public static class Rational
{
        ...
        //
    {
        ...
        //
        int ibot3 = typeMethods.i4_gcd(ibot1, ibot2);
        ibot1 /= ibot3;
        ibot2 /= ibot3;
        //
        ...
        //
        if (i_max < Math.Abs(itop1 * (double)ibot2))
        {
            error = true;
            Console.WriteLine("");
        ...
        if (i_max < Math.Abs(itop2 * (double)ibot1))
        {
            error = true;
            Console.WriteLine("");
            Console.WriteLine("RAT_ADD - Fatal error!");
        ...
        if (i_max < Math.Abs(itop1 + (double)itop2))
        {
            error = true;
            Console.WriteLine("");
            Console.WriteLine("RAT_ADD - Fatal error!");
        ...
        //
        if (i_max <
            Math.Abs(ibot1 * (double)ibot2 * ibot3))
        {
            error = true;
            Console.WriteLine("");
            Console.WriteLine("RAT_ADD - Fatal error!");
        ...
        //
        int itemp = typeMethods.i4_gcd(itop, ibot);
        itop /= itemp;
        ibot /= itemp;
        switch (ibot)
        {
        ...
        //
    {
        ...
        //
        int itemp = typeMethods.i4_gcd(itop1, ibot1);
        itop1 /= itemp;
        ibot1 /= itemp;
        ...
        //
        if (i_max < Math.Abs(ibot1 * (double)itop2))
        {
            error = true;
            Console.WriteLine("");
            Console.WriteLine("RAT_DIV - Fatal error!");
        ...
        //
    {
        ...
        //
        if (i_max < Math.Abs(ibot1 * (double)ibot2))
        {
            error = true;
            Console.WriteLine("");
            Console.WriteLine("RAT_MUL - Fatal error!");
        ...
        //
    {
        ...
        int c = typeMethods.i4_gcd(Math.Abs(a), Math.Abs(b));
        ...
        //
    {
        ...
        //
        int gcd = typeMethods.i4_gcd(rat_top, rat_bot);
        rat_top /= gcd;
        rat_bot /= gcd;
        switch (rat_bot)
        {
        ...
        //
        double r = rat_top / (double)rat_bot;
        ...
        //
    {
        ...
        for (;;)
        {
            ...
            for (i = 0; i < n; i++)
            {
                int itop2 = iatop[i + iarray[i] * n];
                int ibot2 = iabot[i + iarray[i] * n];
