...
public static class Rotation
{
        ...
        //
    {
        ...
        //
        double[] u = typeMethods.r8vec_copy_new(3, axis);

        double axis_norm = typeMethods.r8vec_norm(3, u);
        ...
        //
        double dot = typeMethods.r8vec_dot_product(3, u, v);
        //
        ...
        double normal_component = typeMethods.r8vec_norm(3, normal);
        ...
        //
        double[] normal2 = typeMethods.r8vec_cross_product(u, normal);

        double norm = typeMethods.r8vec_norm(3, normal2);
        ...
        //
    {
        ...
        double norm = Math.Sqrt(v1 * v1 + v2 * v2 + v3 * v3);
    ...
    public static double[] rotation_axis2quat(double[] axis, double angle)
        ...
        //
    {
        double norm = typeMethods.r8vec_norm(3, axis);
    ...
    public static double[] rotation_mat_vector(double[] a, double[] v)
        ...
        //
    {
        double[] w = typeMethods.r8mat_mv_new(3, 3, a, v);
    ...
    public static void rotation_mat2axis(double[] a, double[] axis, ref double angle)
        ...
        //
    {
        double norm = Math.Sqrt((a[2 + 1 * 3] - a[1 + 2 * 3]) * (a[2 + 1 * 3] - a[1 + 2 * 3])
        ...
        //
    {
        ...
        double angle = typeMethods.r8_acos(0.5 *
                                           (a[0 + 0 * 3] + a[1 + 1 * 3] + a[2 + 2 * 3] - 1.0));

        double cos_phi = Math.Cos(0.5 * angle);
    ...
    public static void rotation_quat2axis(double[] q, double[] axis, ref double angle)
        ...
        //
    {
        double sin_phi = Math.Sqrt(q[1] * q[1] + q[2] * q[2] + q[3] * q[3]);
        ...
        //
    {
        ...
        double angle = 2.0 * Math.Atan2(sin_phi, cos_phi);
