...
public static class Hofstadter
{
        ...
        //
    {
        ...
        {
            <= 0 => 0,
            _ => n - g_hofstadter(g_hofstadter(n - 1))
        };
    }
        ...
        //
    {
        ...
        {
            <= 0 => 0,
            _ => n - h_hofstadter(h_hofstadter(h_hofstadter(n - 1)))
        };
    }
        ...
        //
    {
        return n switch
        {
            <= 0 => 0,
            <= 4 => 1,
            _ => v_hofstadter(n - v_hofstadter(n - 1)) + v_hofstadter(n - v_hofstadter(n - 4))
        };
    }
