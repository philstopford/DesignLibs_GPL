    ...
    public static class SGMGAniso
    {
            ...
            //
        {
            ...
            for (dim = 0; dim < dim_num; dim++)
            {
                ...
                for (level = 0; level <= level_1d_max[dim]; level++)
                {
                    ...
                    {
                        Burkardt.Legendre.QuadratureRule.legendre_compute_points_np(
                            order, np[dim], p.Skip(p_index).ToArray(), points);
                    }
                    else if (rule[dim] == 5)
                    {
                    ...
                    {
                        Burkardt.Laguerre.QuadratureRule.laguerre_compute_points_np(
                            order, np[dim], p.Skip(p_index).ToArray(), points);
                    }
                    else if (rule[dim] == 8)
                    {
                        Burkardt.Laguerre.QuadratureRule.gen_laguerre_compute_points_np(
                            order, np[dim], p.Skip(p_index).ToArray(), points);
                    }
                    else if (rule[dim] == 9)
                    {
            ...
            //
        {
            ...
            for (dim = 0; dim < dim_num; dim++)
            {
                ...
                {
                    Burkardt.Legendre.QuadratureRule.legendre_compute_weights_np(
                        order_1d[dim], np[dim], p.Skip(p_index).ToArray(), weight_1d);
                }
                else if (rule[dim] == 5)
                {
                ...
                {
                    Burkardt.Laguerre.QuadratureRule.laguerre_compute_weights_np(
                        order_1d[dim], np[dim], p.Skip(p_index).ToArray(), weight_1d);
                }
                else if (rule[dim] == 8)
                {
                    Burkardt.Laguerre.QuadratureRule.gen_laguerre_compute_weights_np(
                        order_1d[dim], np[dim], p.Skip(p_index).ToArray(), weight_1d);
                }
                else if (rule[dim] == 9)
                {
            ...
            //
        {
            ...
            for (;;)
            {
                ...
                point_total_num = point_total_num + typeMethods.i4vec_product(dim_num,
                    order_1d);
            }
            ...
            for (;;)
            {
                ...
                else if (data.dir == -1 || data.dir == 0)
                {
                    ...
                    else if (data.n2 == data.nstart && data.dir == -1)
                    {
                        ...
                        data.xmin = (int) Math.Ceiling(t / w[data.n2]);
                        if (data.xmin < 0)
                        {
                            data.xmin = 0;
                        }
            ...
            //
        {
            ...
            for (;;)
            {
                ...
                if (q <= q_max)
                {
                    coef = coef + typeMethods.r8_mop(b_sum);
                }
            }
