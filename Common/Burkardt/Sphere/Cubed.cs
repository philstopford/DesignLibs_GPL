...
public static class Cubed
{
        ...
        //
    {
        ...
        double xyzn = Math.Sqrt(xc * xc + yc * yc + zc * zc);
        ...
        //
    {
        ...
        double[] line_data = new double[3 * 2 * line_num];
        int l = 0;
        switch (n)
        {
            //
            ...
            //
            case 1:
                sphere_cubed_ijk_to_xyz(n, 0, 0, 0, ref line_data, xyzIndex: +0 + 0 * 3 );
                sphere_cubed_ijk_to_xyz(n, n, 0, 0, ref line_data, xyzIndex: +0 + 1 * 3 );
                l += 1;
                sphere_cubed_ijk_to_xyz(n, n, 0, 0, ref line_data, xyzIndex: +0 + 0 * 3 + 6);
                sphere_cubed_ijk_to_xyz(n, n, n, 0, ref line_data, xyzIndex: +0 + 1 * 3 + 6);
                l += 1;
        ...
        sphere_cubed_ijk_to_xyz(n, 0, 0, 0, ref line_data, xyzIndex: +0 + 0 * 3);
        sphere_cubed_ijk_to_xyz(n, 1, 0, 0, ref line_data, xyzIndex: +0 + 1 * 3);
        l += 1;
        sphere_cubed_ijk_to_xyz(n, 0, 0, 0, ref line_data, xyzIndex: +0 + 0 * 3 + 6);
        sphere_cubed_ijk_to_xyz(n, 0, 1, 0, ref line_data, xyzIndex: +0 + 1 * 3 + 6);
        l += 1;
        sphere_cubed_ijk_to_xyz(n, 0, 0, 0, ref line_data, xyzIndex: +0 + 0 * 3 + l * 6);
    ...
    public static int sphere_cubed_point_num(int n)
        ...
        //
    {
        int ns = (int)(Math.Pow(n + 1, 3) - Math.Pow(n - 1, 3));
