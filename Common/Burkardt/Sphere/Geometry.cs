...
namespace Burkardt.SphereNS
{
    public static class Geometry
    {
            ...
            //
        {
            ...
            Burkardt.TetrahedronNS.Geometry.tetrahedron_circumsphere_3d(tet, ref r, ref pc);
        }
            ...
            //
        {
            ...
            else if (typeMethods.r8vec_eq(DIM_NUM, p, pc))
            {
                pp[0] = pc[0];
                pp[1] = pc[1];
                pp[2] = pc[2] + r;
            ...
            //
        {
            ...
            if ((dim_num % 2) == 0)
            {
                value = Math.Pow(2.0 * Math.PI, dim_num / 2);
            }
            else
            {
                value = 2.0 * Math.Pow(2.0 * Math.PI, (dim_num - 1) / 2);
            }

            value = value / (double) (typeMethods.i4_factorial2(dim_num - 2));
            ...
            //
        {
            ...
            for (j = 0; j < n; j++)
            {
                ...
                area = area + Math.Atan2(Math.Tan((lam1 - lam2) / 2.0) * (tbeta1 + tbeta2),
                    (1.0 + tbeta1 * tbeta2));
            }
