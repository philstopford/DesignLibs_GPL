...
namespace Burkardt.Square
{
    public static class FelippaRule
    {
            ...
            //
        {
            ...
            double[] w_1d;
            double[] x_1d;
            typeMethods.r8vecDPData data1 = new typeMethods.r8vecDPData();
            typeMethods.r8vecDPData data2 = new typeMethods.r8vecDPData();
            ...
            for (i = 0; i < 2; i++)
            {
                ...
                if (o == 1)
                {
                    Burkardt.LineNS.Felippa.line_unit_o01(ref w_1d, ref x_1d);
                }
                else if (o == 2)
                {
                    Burkardt.LineNS.Felippa.line_unit_o02(ref w_1d, ref x_1d);
                }
                else if (o == 3)
                {
                    Burkardt.LineNS.Felippa.line_unit_o03(ref w_1d, ref x_1d);
                }
                else if (o == 4)
                {
                    Burkardt.LineNS.Felippa.line_unit_o04(ref w_1d, ref x_1d);
                }
                else if (o == 5)
                {
                    Burkardt.LineNS.Felippa.line_unit_o05(ref w_1d, ref x_1d);
                }
                else
                {
                    Console.WriteLine("");
