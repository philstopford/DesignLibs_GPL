...
{
    public static class Symq
    {
        public static int rule_full_size(int degree)
            ...
            //
        {
            ...
            else
            {
                ...
                Console.WriteLine("  Degree DEGREE must be between 1 and 20.");
                return (1);
            }
        ...
        public static void square_symq(int degree, int n, ref double[] x, ref double[] w)
            ...
            //
        {
            ...
            {
                Console.WriteLine("");
                Console.WriteLine("SQUARE_SYMQ - Fatal error");
        ...
        public static void square_symq_gnuplot(int n, double[] x, string header)
