...
namespace Burkardt.TestValues
{
    public class Cmplex
    {
        ...
        //
        {
            ...
            Complex[] fz_vec =
            {
                new Complex(1.039720770839918, -2.356194490192345),
                new Complex(0.804718956217050, +2.677945044588987),
                new Complex(0.346573590279973, -2.356194490192345),
                new Complex(0.000000000000000, +3.141592653589793),
                new Complex(0.693147180559945, -1.570796326794897),
                new Complex(0.000000000000000, -1.570796326794897),
                new Complex(0.000000000000000, +1.570796326794897),
                new Complex(0.693147180559945, +1.570796326794897),
                new Complex(0.346573590279973, -0.785398163397448),
                new Complex(0.000000000000000, +0.000000000000000),
                new Complex(1.039720770839918, -0.785398163397448),
                new Complex(0.804718956217050, +0.463647609000806)
            }
            ;
            Complex[] z_vec =
            {
