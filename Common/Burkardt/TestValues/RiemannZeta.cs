namespace Burkardt.TestValues
{
    public static class RiemannZeta
    {
        public static void zeta_values(ref int n_data, ref int n, ref double zeta)
            ...
            //
            //    Output, ref int N, the argument of the Zeta function.
            //
            //    Output, ref double ZETA, the value of the Zeta function.
            //
        {
            int N_MAX = 15;
        ...
        public static void zeta_m1_values(ref int n_data, ref double p, ref double zeta_m1)
            ...
            //    output value of N_DATA will be 0 again.
            //
            //    Output, ref double P, the argument.
            //
            //    Output, ref double ZETA_M1, the value.
            //
        {
            int N_MAX = 17;
