...
namespace Burkardt.TetrahedronNS
{
    public static class QuadratureRule
    {
        ...
        public static void tetrahedron_arbq(int degree, int n, ref double[] x, ref double[] w)
            ...
            //
        {
            ...
            {
                Console.WriteLine("");
                Console.WriteLine("TETRAHEDRON_ARBQ - Fatal error");
        ...
        public static void tetrahedron_arbq_gnuplot(int n, double[] x, string header)
        ...
        public static int tetrahedron_arbq_size(int degree)
            ...
            //
        {
            ...
            {
                Console.WriteLine("");
                Console.WriteLine("TETRAHEDRON_ARBQ_SIZE - Fatal error!");
                Console.WriteLine("  Illegal value of DEGREE.");
                return (1);
            }
        ...
        public static void tetrahedron_ref(ref double[] v1, ref double[] v2, ref double[] v3, ref double[] v4)
            ...
            //
        {
            ...
            v1[0] = -1.0;
            v1[1] = -1.0 / Math.Sqrt(3.0);
            v1[2] = -1.0 / Math.Sqrt(6.0);

            v2[0] = 0.0;
            v2[1] = 2.0 / Math.Sqrt(3.0);
            v2[2] = -1.0 / Math.Sqrt(6.0);

            v3[0] = 1.0;
            v3[1] = -1.0 / Math.Sqrt(3.0);
            v3[2] = -1.0 / Math.Sqrt(6.0);
