    ...
    public static class Geometry
    {
            ...
            //
        {
            ...
            for (j = 0; j < DIM_NUM; j++)
            {
                ...
                for (i = 0; i < DIM_NUM; i++)
                {
                    s[j] = s[j] + Math.Pow(t[i + j * DIM_NUM] - t[i + jp1 * DIM_NUM], 2);
                }
            ...
            //
        {
            ...
            //
            ival = Burkardt.Plane.Geometry.plane_normal_line_exp_int_3d(t, normal, p1, p2, ref pint);
            ...
            //
        {
            ...
            for (r = 0; r < 3; r++)
            {
                ...
                //
                Burkardt.LineNS.Geometry.line_exp2imp_2d(t, t, ref a1, ref b1, ref c1, +0 + r * 2, +0 + s * 2);
                //
                //  Seek an intersection with the original line.
                //
                Burkardt.LineNS.Geometry.lines_imp_int_2d(a, b, c, a1, b1, c1, ref ival, ref p);
                //
            ...
            //
        {
            ...
            //
            p23 = Burkardt.LineNS.Geometry.line_exp_perp_2d(t, t, t, ref flag, +1 * 2, +2 * 2 + 0 * 2);
            ...
            //
            p31 = Burkardt.LineNS.Geometry.line_exp_perp_2d(t, t, t, ref flag, +2 * 2, +0 * 2, +1 * 2);
            ...
            //  through P2 and P31.
            //
            Burkardt.LineNS.Geometry.lines_exp_int_2d(t, p23, t, p31, ref ival, ref p, p1Index: +0 * 2,
                p3Index: +1 * 2);
            ...
            //
        {
            ...
            //
            dis12 = Burkardt.LineNS.Geometry.line_exp_point_dist_signed_2d(t, t, p, +0 * 2, +1 * 2);
            dis23 = Burkardt.LineNS.Geometry.line_exp_point_dist_signed_2d(t, t, p, +1 * 2, +2 * 2);
            dis31 = Burkardt.LineNS.Geometry.line_exp_point_dist_signed_2d(t, t, p, +2 * 2, +0 * 2);
            //
            ...
            //
        {
            ...
            for (i = 0; i < DIM_NUM; i++)
            {
                a = a + Math.Pow(t[i + 0 * DIM_NUM] - t[i + 1 * DIM_NUM], 2);
                b = b + Math.Pow(t[i + 1 * DIM_NUM] - t[i + 2 * DIM_NUM], 2);
                c = c + Math.Pow(t[i + 2 * DIM_NUM] - t[i + 0 * DIM_NUM], 2);
            }
