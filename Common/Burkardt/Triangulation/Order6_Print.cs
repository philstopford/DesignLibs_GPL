...
{
    public static void triangulation_order6_print(int node_num, int triangle_num,
        ...
        //
    {
        ...
        Console.WriteLine("");
        Console.WriteLine("  Sets of six nodes are used as vertices of");
        Console.WriteLine("  the triangles.  For each triangle, the vertices are listed");
        Console.WriteLine("  in counterclockwise order, followed by the midside nodes.");

        typeMethods.i4mat_transpose_print(6, triangle_num, triangle_node, "  Triangle nodes");
