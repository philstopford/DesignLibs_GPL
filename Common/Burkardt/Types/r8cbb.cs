    ...
    public static partial class typeMethods
    {
            ...
            //
        {
            ...
            for (i = 1; i <= n1; i++)
            {
                ...
                {
                    a[base_ + i - 1 + (j - n1 - 1) * n1] = (double) (fac * i + j);
                }
            }
            ...
            for (i = n1 + 1; i <= n1 + n2; i++)
            {
                for (j = 1; j <= n1; j++)
                {
                    a[base_ + i - n1 - 1 + (j - 1) * n2] = (double) (fac * i + j);
                }
            }
            ...
            for (i = n1 + 1; i <= n1 + n2; i++)
            {
                for (j = n1 + 1; j <= n1 + n2; j++)
                {
                    a[base_ + i - n1 - 1 + (j - n1 - 1) * n2] = (double) (fac * i + j);
                }
            }
            ...
            //
        {
            ...
            for (j = 1; j <= n1; j++)
            {
                for (row = 1; row <= ml + mu + 1; row++)
                {
                    ...
                    if (1 <= i && i <= n1)
                    {
                        a[row - 1 + (j - 1) * (ml + mu + 1)] = UniformRNG.r8_uniform_01(ref seed);
                    }
                }
            }
