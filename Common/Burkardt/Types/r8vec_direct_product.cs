...
public static partial class typeMethods
{
        ...
        //
    {
        ...
        data.rep /= factor_order;data.
            skip *= factor_order;

        for (i = 0; i < factor_order; i++)
        {
            int start = 0 + i * data.contig;
        ...
        //
    {
        ...
        data.rep /= factor_order;
        data.skip *= factor_order;

        for (j = 0; j < factor_order; j++)
        {
            int start = 0 + j * data.contig;
            ...
            for (k = 1; k <= data.rep; k++)
            {
                ...
                {
                    w[i] *= factor_value[factorValueIndex + j];
                }
