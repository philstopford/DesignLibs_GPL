    ...
    public static class Sphere
    {
            ...
            //
        {
            ...
            for (j = 0; j < n; j++)
            {
                ...
                //
                norm = typeMethods.r8vec_norm(m, v);
                //
            ...
            //
        {
            ...
            for (j = 0; j < n; j++)
            {
                phi = UniformRNG.r8_uniform_01(ref seed);
            ...
            //
        {
            ...
            tp = UniformRNG.r8mat_uniform_01_new(2, n, ref seed);
        ...
        //
        {
            ...
            area = Stri.stri_angles_to_area(r, alpha, beta, gamma);
            ...
            for (j = 0; j < n; j++)
            {
                ...
                temp = typeMethods.r8vec_norm(3, v31);
                for (i = 0; i < 3; i++)
                {
                    v31[i] = v31[i] / temp;
                }
