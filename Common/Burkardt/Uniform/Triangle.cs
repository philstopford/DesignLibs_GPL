...
public static class Triangle
{
        ...
        //
    {
        ...
        double l1 = Math.Sqrt(Math.Pow(v[0 + 1 * 2] - v[0 + 0 * 2], 2)
                              + Math.Pow(v[1 + 1 * 2] - v[1 + 0 * 2], 2));

        double l2 = Math.Sqrt(Math.Pow(v[0 + 2 * 2] - v[0 + 1 * 2], 2)
                              + Math.Pow(v[1 + 2 * 2] - v[1 + 1 * 2], 2));

        double l3 = Math.Sqrt(Math.Pow(v[0 + 0 * 2] - v[0 + 2 * 2], 2)
        ...
        for (j = 0; j < n; j++)
        {
            ...
            //
            double r = (l1 + l2 + l3) * UniformRNG.r8_uniform_01(ref seed);
            //
        ...
        //
    {
        ...
        for (j = 0; j < n; j++)
        {
            ...
            //  as measured from the origin, along the perimeter.
            //
            double r = (2.0 + s) * UniformRNG.r8_uniform_01(ref seed);
            //
