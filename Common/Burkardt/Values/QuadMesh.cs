...
public static class QuadMesh
{
        ...
        //
    {
        ...
        for (row = 0; row <= 3; row++)
        {
            for (col = 0; col <= 7; col++)
            {
                element_neighbor[0 + element * 4] = row switch
                {
                    0 => -1,
                    _ => element - 8
                };

                element_neighbor[1 + element * 4] = col switch
                {
                    7 => -1,
                    _ => element + 1
                };

                element_neighbor[2 + element * 4] = row switch
                {
                    3 => -1,
                    _ => element + 8
                };

                element_neighbor[3 + element * 4] = col switch
                {
                    0 => -1,
                    _ => element - 1
                };
