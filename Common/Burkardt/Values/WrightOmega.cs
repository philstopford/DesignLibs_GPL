...
public static class WrightOmega
{
        ...
        //
    {
        ...
        Complex[] fz_vec =
        {
            new(+0.5671432904097838, +0.0000000000000000),
            new(+1.000000000000000, +0.0000000000000000),
            new(+2.718281828459045, +0.0000000000000000),
            new(-1.000000000000000, +0.0000000000000000),
            new(-1.000000000000000, +0.0000000000000000),
            new(-2.000000000000000, +0.0000000000000000),
            new(-0.40637573995996, +0.0000000000000000),
            new(+0.000000000000000, +1.0000000000000000),
            new(-0.3181315052047641, +1.337235701430689),
            new(+0.9372082083733697, +0.5054213160131512)
        };

        Complex[] z_vec =
        {
            new(+0.000000000000000, +0.000000000000000),
            new(+1.000000000000000, +0.000000000000000),
            new(+3.718281828459045, +0.000000000000000),
            new(-1.000000000000000, +3.141592653589793),
            new(-1.000000000000000, -3.141592653589793),
            new(-1.306852819440055, +3.141592653589793),
            new(-1.306852819440055, -3.141592653589793),
            new(+0.000000000000000, +2.570796326794897),
            new(+0.000000000000000, +3.141592653589793),
            new(+1.000000000000000, +1.000000000000000)
        };
