...
void normal_01_samples_test ( );
void normal_cdf_test ( );
void normal_samples_test ( );
...
//
{
  ...
  cout << "\n";
  cout << "MULTINOULLI_PDF_TEST\n";
  cout << "  MULTINOULLI_PDF evaluates the Multinoulli PDF.\n";
...
# define SAMPLE_NUM 1000
  ...
  cout << "\n";
  cout << "NORMAL_01_SAMPLES_TEST\n";
  cout << "  NORMAL_01_MEAN computes the Normal 01 mean;\n";
  cout << "  NORMAL_01_SAMPLES samples the Normal 01 distribution;\n";
...
# define SAMPLE_NUM 1000
  ...
  cout << "\n";
  cout << "NORMAL_SAMPLES_TEST\n";
  cout << "  NORMAL_MEAN computes the Normal mean;\n";
  cout << "  NORMAL_SAMPLES samples the Normal distribution;\n";
  ...
  {
    cout << "\n";
    cout << "NORMAL_SAMPLES_TEST - Fatal error!\n";
    cout << "  The parameters are not legal.\n";
    return;
  }
