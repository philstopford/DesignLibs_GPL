...
public class CustomThreadPool
{
    ...
    public int IdlePeriod
    {
        ...
        set
        {
            switch (value)
            {
                case < 0 when value != Timeout.Infinite:
    ...
    public bool CancelWorkItem(object id)
    {
        ...
        lock (queueLock)
        {
            ...
            {
                ThreadPoolWorkItem item = queue[i];
        ...
        lock (stateLock)
        {
            ...
            if (waitPeriod != Timeout.Infinite)
            {
                waitPeriod = waitPeriod switch
                {
                    ...
                    < 0 => 0,
                    _ => (int) (DateTime.UtcNow - lastJob).TotalMilliseconds
                };
            }
    ...
    private class PriorityComparer : IComparer<ThreadPoolWorkItem>
    {
        ...
        public int Compare(ThreadPoolWorkItem x, ThreadPoolWorkItem y)
        {
            ...
            return y switch
            {
                null => throw new ArgumentException("y"),
                _ => x.Priority < y.Priority ? 1 : -1
            };
        }
    }
    #endregion
