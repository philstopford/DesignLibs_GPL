...
namespace Tral.Randomness.Algorithms
{
    ...
    /// </remarks>
    public class Xoshiro256pp : IJumpableAlgorithm
    {
        // Long jump variant
        ...
        private Xoshiro256pp(Xoshiro256pp other)
        {
            _s0 = other._s0;
            _s1 = other._s1;
            _s2 = other._s2;
        ...
        /// </summary>
        public string AlgorithmName { get; } = "xoshiro256++ 1.0";
        ...
        public ulong Next()
        {
            ulong rslt = Rotl(_s0 + _s3, 23) + _s0;
        ...
        /// <summary>
        /// Sets the internal state from an array of 64-bit integers. The array must be of length 4 or greater.
        /// </summary>
