  ...
  using cInt = Int32;
    ...
    public class Clipper : ClipperBase
    {
        ...
        private bool FirstIsBottomPt(OutPt btmPt1, OutPt btmPt2)
        {
            ...
            if (Math.Abs(Math.Max(dx1p, dx1n) - Math.Max(dx2p, dx2n)) < Double.Epsilon &&
              Math.Abs(Math.Min(dx1p, dx1n) - Math.Min(dx2p, dx2n)) < Double.Epsilon)
              ...
              PolyFillType fillType = PolyFillType.pftEvenOdd, bool preserveColinear = false)
        {
            ...
            c.PreserveCollinear = preserveColinear;
    ...
    public class ClipperOffset
    {
        ...
        public void Execute(ref Paths solution, double delta)
        {
            ...
            clpr.PreserveCollinear = PreserveCollinear;
