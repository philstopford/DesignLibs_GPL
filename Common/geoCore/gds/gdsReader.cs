...
internal partial class gdsReader
{
    ...
    private ushort reclen;
    private byte record;
    private byte type, help;

    private int items, int32, int32x, int32y;
    ...
    public struct Modals
    {
        ...
        public int elementmode { get; set; }
        public int anzx { get; set; }
        public int anzy { get; set; }
            ...
            while (pos < len)
            {
                ...
                switch (record)
                {
                    ...
                    case 3: // UNITS
                        ...
                        drawing_.userunits = double_ * 1E16;
                        double_ = read8ByteReal();
                        drawing_.databaseunits = double_ * 1E16;
                        break;
                    case 4: // ENDLIB
                        break;
                    case 5: // BGNSTR
