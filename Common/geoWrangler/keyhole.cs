...
namespace geoWrangler
{
    ...
    public static partial class GeoWrangler
    {
        ...
        static Paths pMakeKeyHole(Paths outers, Paths cutters, double customSizing = 0, double extension = 0, double angularTolerance = 0)
        {
            ...
            try
            {
                ...
                foreach (Path t in cutters)
                {
                    ...
                    RayCast rc = new RayCast(t, outers, 1000000, invert: true, projectCorners: projectCorners);
        ...
        static Paths pInflateEdge(Path edge, double customSizing)
        {
            ...
            ClipperOffset co = new ClipperOffset {PreserveCollinear = true};
        ...
        static Paths pRemoveFragments(Paths source, double customSizing, double extension, bool maySimplify = false, JoinType joinType = JoinType.jtMiter)
        {
            ...
            ClipperOffset co = new ClipperOffset {PreserveCollinear = !maySimplify};
