...
namespace geoWrangler
{
    public static partial class GeoWrangler
    {
        ...
        public static double angleBetweenPoints(IntPoint interSection_A, IntPoint interSection_B, IntPoint interSection_C)
        {
            return pAngleBetweenPoints(interSection_A, interSection_B, interSection_C);
        }

        static double pAngleBetweenPoints(IntPoint interSection_A, IntPoint interSection_B, IntPoint interSection_C)
        {
            ...
            return angleCalc(cAVector.X, cAVector.Y, cBVector.X, cBVector.Y, scalarProduct);
        }

        static double angleCalc(Int64 aVX, Int64 aVY, Int64 bVX, Int64 bVY, Int64 scalarProduct)
        {
        ...
        public static double angleBetweenPoints(GeoLibPoint interSection_A, GeoLibPoint interSection_B, GeoLibPoint interSection_C)
        {
            return pAngleBetweenPoints(interSection_A, interSection_B, interSection_C);
        }

        static double pAngleBetweenPoints(GeoLibPoint interSection_A, GeoLibPoint interSection_B, GeoLibPoint interSection_C)
        {
        ...
        public static double angleBetweenPoints(GeoLibPointF interSection_A, GeoLibPointF interSection_B, GeoLibPointF interSection_C)
        {
            return pAngleBetweenPoints(interSection_A, interSection_B, interSection_C);
        }

        static double pAngleBetweenPoints(GeoLibPointF interSection_A, GeoLibPointF interSection_B, GeoLibPointF interSection_C)
        {
        ...
        static double angleCalc(double aVX, double aVY, double bVX, double bVY, double scalarProduct)
        {
            double cBMagnitude = (Math.Sqrt(Utils.myPow(bVX, 2) + Utils.myPow(bVY, 2)));
            double cAMagnitude = (Math.Sqrt(Utils.myPow(aVX, 2) + Utils.myPow(aVY, 2)));
